				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 1.438e-5;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 2.528e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = 1.216e-4;
