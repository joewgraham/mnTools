...
% Branch Type Probability
    ...
    input.probability.branch.mode = 'diameterbranchorder';
    ...
    input.probability.branch.parameter1 = 1.889e0; %1.380e0;
    % Non-multiplicative parameter in all cases
    input.probability.branch.parameter2 = -1.489e0; %-1.392e0;
    % Multiplicative parameter if mode is not doublebin
    % Diameter multiplicative parameter if mode is doublebin
    input.probability.branch.parameter3 = 1.126e-1; %1.608e-3;
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.mean.singlebin.fit = 'exponential'; %offset unweighted  %%'exponential'; %unweighted 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 4.317e-3; %%3.765e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = -8.910e-3; %%-5.485e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = 2.890e-4; %%NaN; 
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.sd.singlebin.fit = 'exponential'; %unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 6.146e-3; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = -1.541e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.skew.singlebin.fit = 'linear'; %unweighted 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = -2.340e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = 1.243e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.kurt.singlebin.fit = 'linear'; %unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = -6.312e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = 2.546e1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				% Double Bin
					...
					input.piecebifprob.dependent.doublebin.firstfit = 'exponential'; %offset robust weighted
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.piecebifprob.dependent.doublebin.parameter(1).fit = 'linear'; %robust weighted
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = 8.013e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = 7.910e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = -3.175e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = -2.630e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(1) = 1.900e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(2) = 1.050e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
