...
% Minimum dendritic diameter
    ...
    input.mindendriticdiameter = 2.600e-1;


% Branch Type Probability

    input.probability.branch.mode = 'diameterpathlength'; %'diameterbranchorder';
    % Either 'pathlength', 'diameter', 'diameterpathlength', or 'diameterbranchorder'

	input.probability.branch.mindiameter = NaN; %7.800e-1;
	...
	input.probability.branch.maxbranchorder = NaN; %12;
	% Maximum value for bifurcation
	% Either NaN or numeric value
    ...
    input.probability.branch.parameter1 = 1.380e0; %1.889e0; 
    % Non-multiplicative parameter in all cases
    input.probability.branch.parameter2 = -1.392e0; %-1.489e0; 
    % Multiplicative parameter if mode is not doublebin
    % Diameter multiplicative parameter if mode is doublebin
    input.probability.branch.parameter3 = 1.609e-3; %1.126e-1; 
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.mean.singlebin.fit = 'exponential'; %off wt   %'power'; %off rw %off wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 3.436e-3; %1.671e-4; %3.353e-4
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 9.377e-2; %1.482e0; %1.119e0
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = -3.961e-3; %-2.809e-4; %-5.408e-4 
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.sd.singlebin.fit = 'linear'; %rb %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 5.984e-4; % 7.691e-4; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 8.339e-4; %7.918e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.skew.singlebin.fit = 'linear'; %'exponential'; %off rb  %'linear'; %uw 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = 0; %-9.264e0; %3.369e-1; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = 0; %-9.460e-1; %-1.082e0; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(3) = NaN; %1.272e0; %NaN;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Bifurcation Taper Rate Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.kurt.singlebin.fit = 'linear'; %'power'; %wt %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = 0; %1.909e1; %1.612e1
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = 3; %-4.438e-1; %-2.356e-1
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.termination.dependent.mean.singlebin.fit = 'exponential'; %offset rw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.termination.dependent.mean.singlebin.parameter(1) = 2.850e-2; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.mean.singlebin.parameter(2) = 5.548e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.termination.dependent.mean.singlebin.parameter(3) = -2.938e-2;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.termination.dependent.sd.singlebin.parameter(1) = 1.317e-3; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.sd.singlebin.parameter(2) = 6.705e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.termination.dependent.skew.singlebin.fit = 'linear'; %rw %uw %wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.termination.dependent.skew.singlebin.parameter(1) = 0; %-4.978e-1; %-5.935e-1; %-3.155e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.skew.singlebin.parameter(2) = 0; %1.596e0; %1.683e0; %1.275e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.termination.dependent.kurt.singlebin.fit = 'linear'; %'power'; %off wt %off rb %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.termination.dependent.kurt.singlebin.parameter(1) = 0; %7.748e0; %5.462e0; %1.222e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.kurt.singlebin.parameter(2) = 3; %-3.047e0; %-3.949e0; %-2.281e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.termination.dependent.kurt.singlebin.parameter(3) = NaN; %4.469e0; %2.929e0; %1.074e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				% Double Bin
					...
					input.piecebifprob.dependent.doublebin.firstfit = 'power'; %off wt
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.piecebifprob.dependent.doublebin.parameter(1).fit = 'exponential'; % off rw 
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = 1.125e-5;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = 1.287e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(3) = 4.787e-5;
						...
						input.piecebifprob.dependent.doublebin.parameter(2).fit = 'exponential'; %rb
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = 2.954e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = 4.947e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.piecebifprob.dependent.doublebin.parameter(3).fit = 'exponential'; %off
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(3).parameter(1) = 8.215e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(2) = 2.518e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(3) = 1.661e-3;
							% Linear: N/A | Exponential: a2 | Power: N/A | Sigmoidal: halfmax
    ...
    % Piece Termination Probability dependency
		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				input.piecetermprob.dependent.mean.by = 'length';
				% Either 'length', 'surface area' or 'volume'
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.piecetermprob.dependent.singlebin.fit = 'exponential'; %offset unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecetermprob.dependent.singlebin.parameter(1) = 2.163e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecetermprob.dependent.singlebin.parameter(2) = -2.014e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecetermprob.dependent.singlebin.parameter(3) = -1.022e-4;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.rallratio.dependent.mean.singlebin.fit = 'exponential'; %off uw %'power'; %off uw 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.rallratio.dependent.mean.singlebin.parameter(1) = 1.723; %3.436e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.mean.singlebin.parameter(2) = -1.702; %-1.428e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.rallratio.dependent.mean.singlebin.parameter(3) = 1.096; %1.057e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.rallratio.dependent.sd.singlebin.parameter(1) = 2.230e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.sd.singlebin.parameter(2) = -1.518e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.rallratio.dependent.sd.singlebin.parameter(3) = 2.570e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.rallratio.dependent.skew.singlebin.fit = 'linear'; %uw %'exponential'; %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.rallratio.dependent.skew.singlebin.parameter(1) = -6.992e-2; %1.191e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.skew.singlebin.parameter(2) = 1.196e0; %-1.825e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.rallratio.dependent.skew.singlebin.parameter(3) = NaN; %6.572e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.rallratio.dependent.kurt.singlebin.parameter(1) = 2.038e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.kurt.singlebin.parameter(2) = -1.012e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.rallratio.dependent.kurt.singlebin.parameter(3) = 3.805e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
