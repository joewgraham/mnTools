			...
			% Bifurcation Taper Rate Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.skew.singlebin.fit = 'exponential'; %off rb  %'linear'; %uw 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = -9.264e0; %3.369e-1; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = -9.460e-1; %-1.082e0; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(3) = 1.272e0; %NaN;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Bifurcation Taper Rate Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.kurt.singlebin.fit = 'power'; %wt %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = 1.909e1; %1.612e1
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = -4.438e-1; %-2.356e-1
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.termination.dependent.skew.singlebin.parameter(1) = -4.978e-1; %-5.935e-1; %-3.155e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.skew.singlebin.parameter(2) = 1.596e0; %1.683e0; %1.275e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.termination.dependent.kurt.singlebin.fit = 'power'; %off wt %off rb %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.termination.dependent.kurt.singlebin.parameter(1) = 7.748e0; %5.462e0; %1.222e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.kurt.singlebin.parameter(2) = -3.047e0; %-3.949e0; %-2.281e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.termination.dependent.kurt.singlebin.parameter(3) = 4.469e0; %2.929e0; %1.074e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
