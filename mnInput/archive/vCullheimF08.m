...
% Soma diameter
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
		...
		input.somadiameter.preset   = [47.7 49.2 54.6 47.7 49.2 54.6]; %[ 47.7 49.2 54.6]; %[60.0 
...
% Number primary dendrites
   ...
   % 'constant', 'uniform', 'normal', 'pearson', or 'preset'
		...
		input.numberprimarydendrites.preset       = [13 12 8 13 12 8]; %[ 13 12 8]; %[10 
...
% Primary dendrite diameters
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
		...
		%
		input.primarydendritediameter.preset{4} = [7.68 8.74 4.5 10.6 3.97 12.19 9.01 9.01 6.09 7.15 5.83 9.27 9.8];
		input.primarydendritediameter.preset{5} = [6.62 10.86 5.03 7.95 7.42 8.21 5.83 7.68 1.85 4.39 6.36 5.3];
		input.primarydendritediameter.preset{6} = [8.02 11.23 7.75 7.22 7.75 5.67 5.08 5.35];
		%
    ...
    % Bifurcation Taper Rate dependency
		...
		% Bifurcation Taper Rate independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.taperrate.bifurcation.skew         = 1.231;
				input.taperrate.bifurcation.kurt         = 25.08; 
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.mean.singlebin.fit = 'linear'; %unweighted %'power'; %weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 2.364e-4; %2.714e-5;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = -1.607e-4; %2.252e0;
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 1.096e-3; %weighted
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 6.794e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
    ...
    % Termination Taper Rate dependency
		...
		% Termination Taper Rate independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.taperrate.termination.skew         = 0;
				input.taperrate.termination.kurt         = 3; 
		...
		% Termination Taper Rate dependent
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.termination.dependent.mean.singlebin.parameter(1) = 7.435e-4; %weighted
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.mean.singlebin.parameter(2) = 1.618e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.termination.dependent.sd.singlebin.parameter(1) = 1.289e-3; %weighted
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.sd.singlebin.parameter(2) = 6.299e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Skewness
				...
				input.taperrate.termination.dependent.skew.type = 'independent';
				% Either 'independent', 'singlebin' or 'doublebin'
		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				% Single Bin
					...
					input.piecebifprob.dependent.singlebin.dependent = 'none'; %'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.piecebifprob.dependent.singlebin.fit = 'none'; %'power'; %offset robust weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.singlebin.parameter(1) = NaN; %7.496e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.singlebin.parameter(2) = NaN; %-2.072e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecebifprob.dependent.singlebin.parameter(3) = NaN; %8.438e-5;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
					...
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					   ...
					   input.piecebifprob.dependent.doublebin.parameter(1).fit = 'linear';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = 1.418e-5;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = -6.565e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = 3.488e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = -6.842e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(1) = 3.076e-6;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(2) = -3.392e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
