			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.mean.singlebin.fit = 'power'; %offset rw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 3.353e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 1.119e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = -5.408e-4; 
				...
				% Double Bin
					...
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					   ...
					   input.piecebifprob.dependent.doublebin.parameter(1).fit = 'power'; %rb 
						...
						input.piecebifprob.dependent.doublebin.parameter(3).fit = 'linear'; 
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(3).parameter(1) = 0.000e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(2) = 2.500e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
