			...
			% Rall Ratio Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.rallratio.dependent.mean.singlebin.fit = 'power'; %offset robust weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.rallratio.dependent.mean.singlebin.parameter(1) = 2.504e-1; %2.286e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.mean.singlebin.parameter(2) = -2.323e0; %-1.399e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.rallratio.dependent.mean.singlebin.parameter(3) = 1.077e0; %1.119; % Now overall mean, fit: 1.049e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
