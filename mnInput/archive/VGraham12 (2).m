		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				% Double Bin
					...
					input.piecetermprob.dependent.doublebin.firstfit = 'power'; %rb -- uw
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.piecetermprob.dependent.doublebin.parameter(1).fit = 'exponential';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecetermprob.dependent.doublebin.parameter(1).parameter(1) = 1.129e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecetermprob.dependent.doublebin.parameter(1).parameter(2) = 9.261e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecetermprob.dependent.doublebin.parameter(2).parameter(1) = -2.208e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecetermprob.dependent.doublebin.parameter(2).parameter(2) = -5.143e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
