			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.mean.singlebin.fit = 'linear'; %weighted    %'exponential'; % offset weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 2.483e-4; %5.883e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = -1.607e-4; %2.207e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = NaN; %-7.348e-4;
			...
			% Bifurcation Taper Rate Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.kurt.singlebin.fit = 'linear'; %unweighted %weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = 9.998e-2; %8.285e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = 8.565e0; %6.200e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Piece Bifurcation Probability
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.piecebifprob.dependent.singlebin.fit = 'linear'; % robust
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.singlebin.parameter(1) = 5.687e-6;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.singlebin.parameter(2) = 3.783e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
