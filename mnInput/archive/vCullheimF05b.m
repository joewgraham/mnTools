...
% Branch Type Probability
    ...
    input.probability.branch.parameter1 = 2.838e0;
    % Non-multiplicative parameter in all cases
    input.probability.branch.parameter2 =  -1.753e0;
			...
			% Rall Ratio Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.rallratio.dependent.mean.singlebin.fit = 'power'; %offset weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.rallratio.dependent.mean.singlebin.parameter(1) = 2.286e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.mean.singlebin.parameter(2) = -1.399e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.rallratio.dependent.mean.singlebin.parameter(3) = 1.049e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
    ...
    % Daughter Ratio dependency
		...
		% Daughter Ratio independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.daughterratio.skew         = 2.822;
				input.daughterratio.kurt         = 14.21;
