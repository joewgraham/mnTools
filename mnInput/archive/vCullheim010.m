...
% Branch Type Probability
	...
	input.probability.branch.mindiameter = 0.7800;
	% Minimum value for bifurcation
	% Either NaN or numeric value
	
	input.probability.branch.maxpathlength = 1133;
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.singlebin.parameter(2) = -2.942e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecebifprob.dependent.singlebin.parameter(3) = 2.302e-4;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecetermprob.dependent.singlebin.parameter(1) = 9.372e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecetermprob.dependent.singlebin.parameter(2) = -5.472e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecetermprob.dependent.singlebin.parameter(3) = 5.896e-5;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
