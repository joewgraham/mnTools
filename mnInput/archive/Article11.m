		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				% Single Bin
					...
					input.piecebifprob.dependent.singlebin.dependent = 'branchorder';
					% Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
						
						input.piecebifprob.dependent.singlebin.fit = 'power'; %offset robust weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.singlebin.parameter(1) = 8.694e-5;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.singlebin.parameter(2) = 1.602e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecebifprob.dependent.singlebin.parameter(3) = 8.510e-5;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
				...
				% Double Bin
					...
					input.piecebifprob.dependent.doublebin.firstfit = 'linear'; %unweighted
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.piecebifprob.dependent.doublebin.parameter(1).fit = 'linear'; %robust weighted 
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = -3.020e-6;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = 3.851e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.piecebifprob.dependent.doublebin.parameter(2).fit = 'exponential'; %offset robust
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = 2.825e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = 1.954e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(3) = -9.859e-3;
							% Linear: N/A | Exponential: a2 | Power: N/A | Sigmoidal: halfmax
