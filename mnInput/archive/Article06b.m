					...
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					   ...
					   input.piecebifprob.dependent.doublebin.parameter(1).fit = 'linear'; %robust 
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = -2.974e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = 3.161e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = -3.789e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = -2.667e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(1) = 9.702e-5;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(2) = 1.359e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
