...
% Number primary dendrites
   ...
   % 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.numberprimarydendrites.mean         = 10.80;
        input.numberprimarydendrites.max          = NaN;
        input.numberprimarydendrites.sd           = 1.924;
        input.numberprimarydendrites.skew         = -0.3959;
        input.numberprimarydendrites.kurt         = 1.995;
...
% Primary dendrite diameters
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.primarydendritediameter.mean     = 7.628;
        input.primarydendritediameter.max      = NaN;
        input.primarydendritediameter.sd       = 2.387;
        input.primarydendritediameter.skew     = 0.5133;
        input.primarydendritediameter.kurt     = 3.856;
...
% Branch Type Probability
    ...
    input.probability.branch.type = 'logit'; %'loglog';
    % Either 'logit', 'probit', 'comploglog', or 'loglog'

    input.probability.branch.parameter1 = -2.685e0; %1.380e0; 
    % Non-multiplicative parameter in all cases
    input.probability.branch.parameter2 = 1.876e0; %-1.392e0; 
    % Multiplicative parameter if mode is not doublebin
    % Diameter multiplicative parameter if mode is doublebin
    input.probability.branch.parameter3 = -2.163e-3; %1.609e-3; 
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 1.270e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = -3.218e-4;
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 6.424e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 2.739e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = 4.643e-1; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = -2.757e0; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = -1.118e0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = 2.226e1; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
