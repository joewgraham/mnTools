...
% Primary dendrite diameters
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
		...
		input.primarydendritediameter.preset{1} = 1.1.*[6.24 6.24 8.06 8.58 6.76 6.24 5.72 8.32 8.06 9.36];
		input.primarydendritediameter.preset{2} = 1.1.*[7.68 8.74 4.5 10.6 3.97 12.19 9.01 9.01 6.09 7.15 5.83 9.27 9.8];
		input.primarydendritediameter.preset{3} = 1.1.*[6.62 10.86 5.03 7.95 7.42 8.21 5.83 7.68 1.85 4.39 6.36 5.3];
		input.primarydendritediameter.preset{4} = 1.1.*[8.02 11.23 7.75 7.22 7.75 5.67 5.08 5.35];
...
% Branch Type Probability
    ...
    input.probability.branch.mode = 'doublebin'; %'diameter';
    ...
    input.probability.branch.parameter1 = -2.187e0; %-4.735e0;
    % Non-multiplicative parameter in all cases
    input.probability.branch.parameter2 =  4.975e0; %2.366e0;
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.mean.singlebin.fit = 'power'; %'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 8.732e-4; %5.444e-4; %4.297e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 1.258e0; %-9.803e-4; %-5.054e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = -1.552e-3; %NaN;
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.sd.singlebin.fit = 'power'; %'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 2.621e-3; %9.191e-4; %4.999e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 7.051e-1; %2.986e-4; %1.571e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
					...
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					   ...
					   input.piecebifprob.dependent.doublebin.parameter(1).fit = 'linear';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = 2.359e-6; %7.673e-7; %1.693e-6; %7.672e-7;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = 2.410e-4; %1.923e-3; %1.421e-3; %1.921e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = 2.761e-4; %1.036e-5; %8.533e-6; %1.021e-5;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = 3.218e-1; %-6.021e-3; %-4.810e-3; %-5.934e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
