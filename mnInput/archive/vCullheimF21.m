			...
			% Bifurcation Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.sd.singlebin.fit = 'power'; %weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 1.096e-3; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = 2.640e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = -3.599e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
