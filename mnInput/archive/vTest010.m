			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.bifurcation.dependent.mean.singlebin.fit = 'power'; %offset robust weighted     %%'exponential'; %offset weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 2.969e-4;      %%3.931e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 1.151e0;      %%-8.773e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = -4.671e-4;      %%3.759e-4; 
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.singlebin.parameter(1) = 1.129e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.singlebin.parameter(2) = 1.222e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecebifprob.dependent.singlebin.parameter(3) = -7.243e-4;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
