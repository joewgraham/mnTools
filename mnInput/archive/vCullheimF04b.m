...
% Branch Type Probability
    ...
    input.probability.branch.parameter1 = 1.808; %-2.402; %1.602e0; %2.838e0;
    % Non-multiplicative parameter in all cases
    input.probability.branch.parameter2 =  -3.295; %5.447; %-3.975e-3; %-1.753e0;
    % Multiplicative parameter if mode is not 'doublebin'
    % Diameter multiplicative parameter if mode is 'doublebin'
    input.probability.branch.parameter3 = 2.568e-3; %-6.200e-3; %NaN;
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 1.773e-4; %robust
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = -1.948e-4;
