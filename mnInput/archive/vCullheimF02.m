...
% Branch Type Probability
    ...
    input.probability.branch.mode = 'pathlength';
    ...
    input.probability.branch.type = 'comploglog';
    % Either 'logit', 'probit', 'comploglog', or 'loglog'

    input.probability.branch.parameter1 = 1.602e0; %2.838e0;
    % Non-multiplicative parameter in all cases
    input.probability.branch.parameter2 =  -3.975e-3; %-1.753e0;
