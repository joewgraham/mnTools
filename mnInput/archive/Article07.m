		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				% Double Bin
					...
					input.piecebifprob.dependent.doublebin.secondbin = 'branchorder';
					% Either 'diameter', 'pathlength', 'branchlength' or 'branchorder'
					
					input.piecebifprob.dependent.doublebin.firstfit = 'power'; %offset weighted
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.piecebifprob.dependent.doublebin.parameter(1).fit = 'linear'; %robust 
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = -1.931e-3; %-2.974e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = 2.309e-2; %3.161e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.piecebifprob.dependent.doublebin.parameter(2).fit = 'linear'; %robust
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = -1.541e-1; %-3.789e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = -2.935e0; %-2.667e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.piecebifprob.dependent.doublebin.parameter(3).fit = 'power'; %
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.doublebin.parameter(3).parameter(1) = 2.769e-5; %9.702e-5;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.doublebin.parameter(3).parameter(2) = 2.034e0; %1.359e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
