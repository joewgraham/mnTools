...
% Branch Type Probability
    ...
    input.probability.branch.parameter1 = -2.032;
    % Non-multiplicative parameter in all cases
    input.probability.branch.parameter2 = 4.844;
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.rallratio.dependent.skew.singlebin.parameter(1) = 2.480e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.skew.singlebin.parameter(2) = -6.802e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.rallratio.dependent.kurt.singlebin.parameter(1) = 1.178e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.kurt.singlebin.parameter(2) = -5.436e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
