				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecebifprob.dependent.singlebin.parameter(1) = 1.091e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.singlebin.parameter(2) = -2.489e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.piecetermprob.dependent.singlebin.parameter(1) = 4.651e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecetermprob.dependent.singlebin.parameter(2) = -3.802e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
