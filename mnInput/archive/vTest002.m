		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				% Single Bin
					...
					input.piecebifprob.dependent.singlebin.dependent = 'diameter'; %'pathlength';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.piecebifprob.dependent.singlebin.fit = 'power'; % offset robust
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.piecebifprob.dependent.singlebin.parameter(1) = 1e-10; %4.294e-9;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.piecebifprob.dependent.singlebin.parameter(2) = 2.6; %1.969e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.piecebifprob.dependent.singlebin.parameter(3) = 1.4e-4; %1.037e-4;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
