...
% Rall Ratio
	...
	input.rallratio.rallexponent = 3.0;
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.rallratio.dependent.sd.singlebin.parameter(1) = 2.087e0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.sd.singlebin.parameter(2) = -1.252e0; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Rall Ratio Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.rallratio.dependent.skew.singlebin.fit = 'power';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.rallratio.dependent.skew.singlebin.parameter(1) = 2.888e0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.skew.singlebin.parameter(2) = -3.455e-1; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.rallratio.dependent.kurt.singlebin.parameter(1) = 1.524e1; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.rallratio.dependent.kurt.singlebin.parameter(2) = -3.803e-1; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
