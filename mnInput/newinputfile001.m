...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
        ...
        input.dendrite.piecebifprob.linreg.constant        = 1028;
        input.dendrite.piecebifprob.linreg.diameter        = 492.4;
        input.dendrite.piecebifprob.linreg.pathlength      = -1.562;
        input.dendrite.piecebifprob.linreg.branchorder     = -125.5;
