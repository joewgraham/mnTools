...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
        ...
        input.dendrite.piecebifprob.linreg.constant        = 322.1;
        input.dendrite.piecebifprob.linreg.diameter        = -23.67;
        input.dendrite.piecebifprob.linreg.pathlength      = -0.1995;
        input.dendrite.piecebifprob.linreg.branchorder     = 0;
