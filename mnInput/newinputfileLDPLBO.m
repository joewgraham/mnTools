...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
        ...
        % Either 'independent' or 'linearregress' or 'dependent'
        ...
        input.dendrite.piecebifprob.linreg.constant        = 302.5;
        input.dendrite.piecebifprob.linreg.diameter        = -22.25;
        input.dendrite.piecebifprob.linreg.pathlength      = -0.2294;
        input.dendrite.piecebifprob.linreg.branchorder     = 6.336;
...
% Piece Termination Probability
    ...
    % Piece Termination Probability dependency
        ...
        input.dendrite.piecetermprob.mode = 'linearregress';
        % Either 'independent' or 'dependent'
        ...
        % Piece Termination Probability linear regress
        
        input.dendrite.piecetermprob.linreg.constant        = -1439;
        input.dendrite.piecetermprob.linreg.diameter        = 1719;
        input.dendrite.piecetermprob.linreg.pathlength      = 0.9252;
        input.dendrite.piecetermprob.linreg.branchorder     = 21.65;
        input.dendrite.piecetermprob.linreg.diampathinter   = -1.122;    
