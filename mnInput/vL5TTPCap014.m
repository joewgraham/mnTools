...
% Bifurcation Taper Rate
    ...
    % Bifurcation Taper Rate dependency
		...
		% Bifurcation Taper Rate independent
			...
			input.apical.taperrate.bifurcation.distribution = 'normal';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'

				input.apical.taperrate.bifurcation.const        = 0;
				input.apical.taperrate.bifurcation.min          = NaN; 
				input.apical.taperrate.bifurcation.mean         = 9.800e-4;
				input.apical.taperrate.bifurcation.max          = NaN; 
				input.apical.taperrate.bifurcation.sd           = 0.0532;
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.taperrate.bifurcation.dependent.mean.singlebin.fit = 'power'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

                            input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 9.465e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 2.177e0;
                        	% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = -1.107e-3;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
    ...
    % Rall Ratio dependency
		...
		% Rall Ratio dependent
			...
			% Rall Ratio Standard Deviation
				...
				input.apical.rallratio.dependent.sd.type = 'dependent';
				% Either 'independent', 'singlebin' or 'doublebin'
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.rallratio.dependent.sd.singlebin.fit = 'exponential';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.rallratio.dependent.sd.singlebin.parameter(1) = 2.094e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.rallratio.dependent.sd.singlebin.parameter(2) = -2.595e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.rallratio.dependent.sd.singlebin.parameter(3) = 3.505e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
