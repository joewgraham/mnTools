			...
			% Termination Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.termination.dependent.mean.singlebin.fit = 'exponential'; %offset wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.termination.dependent.mean.singlebin.parameter(1) = 2.844e-2; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.mean.singlebin.parameter(2) = 5.399e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.taperrate.termination.dependent.mean.singlebin.parameter(3) = -2.927e-2;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Termination Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.taperrate.termination.dependent.sd.singlebin.fit = 'linear'; %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.taperrate.termination.dependent.sd.singlebin.parameter(1) = 2.592e-4; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.taperrate.termination.dependent.sd.singlebin.parameter(2) = 1.178e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
