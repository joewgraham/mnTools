...
% Soma diameter
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.somadiameter.mean     = 26.11;
        input.somadiameter.max      = NaN;
        input.somadiameter.sd       = 4.890;
        input.somadiameter.skew     = 1.334;
        input.somadiameter.kurt     = 6.958;
		
		input.somadiameter.preset   = []; 
...
% Number of trunks
   ...
   input.axon.numbertrunks.distribution = 'normal';
   % 'constant', 'uniform', 'normal', 'pearson', or 'preset'

        input.axon.numbertrunks.const        = NaN;
        input.axon.numbertrunks.min          = NaN;
        input.axon.numbertrunks.mean         = 10.75;
        input.axon.numbertrunks.max          = NaN;
        input.axon.numbertrunks.sd           = 2.217;
        input.axon.numbertrunks.skew         = -0.2780;
        input.axon.numbertrunks.kurt         = 1.573;
		
		input.axon.numbertrunks.preset       = [10 13 12 8]; 
...
% Trunk diameters
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.axon.trunkdiameter.mean     = 7.279;
        input.axon.trunkdiameter.max      = NaN;
        input.axon.trunkdiameter.sd       = 2.084;
        input.axon.trunkdiameter.skew     = 0.04486;
        input.axon.trunkdiameter.kurt     = 3.323;
		
		input.axon.trunkdiameter.preset{1} = [6.24 6.24 8.06 8.58 6.76 6.24 5.72 8.32 8.06 9.36];
		input.axon.trunkdiameter.preset{2} = [7.68 8.74 4.5 10.6 3.97 12.19 9.01 9.01 6.09 7.15 5.83 9.27 9.8];
		input.axon.trunkdiameter.preset{3} = [6.62 10.86 5.03 7.95 7.42 8.21 5.83 7.68 1.85 4.39 6.36 5.3];
		input.axon.trunkdiameter.preset{4} = [8.02 11.23 7.75 7.22 7.75 5.67 5.08 5.35];
...
% Meander angle
     ...
     input.axon.meanderangle.distribution = 'uniform';

        input.axon.meanderangle.const    = NaN;
        input.axon.meanderangle.min      = -1;
        input.axon.meanderangle.mean     = NaN;
        input.axon.meanderangle.max      = 1;
...
% Minimum dendritic diameter
    ...
    input.axon.mindendriticdiameter = 0.26;


% Branch Type Probability

    input.axon.probability.branch.mode = 'diameterpathlength'; 
    ...
    input.axon.probability.branch.type = 'loglog';
    % Either 'logit', 'probit', 'comploglog', or 'loglog'

    input.axon.probability.branch.parameter1 = 1.353e0; 
    % Non-multiplicative parameter in all cases
    input.axon.probability.branch.parameter2 = -1.373e0; 
    % Multiplicative parameter if mode is not doublebin
    % Diameter multiplicative parameter if mode is doublebin
    input.axon.probability.branch.parameter3 = 1.612e-3; 
...
% Bifurcation Taper Rate
    ...
    % Bifurcation Taper Rate dependency
		...
		input.axon.taperrate.bifurcation.by = 'diameter';
        % Either 'diameter', 'surfacearea', or 'volume'

        input.axon.taperrate.bifurcation.mode = 'dependent';
        % Either 'independent' or 'dependent'

		% Bifurcation Taper Rate independent

			input.axon.taperrate.bifurcation.distribution = 'none';
		...
		% Bifurcation Taper Rate dependent
			...
			% Bifurcation Taper Rate Mean
				...
				input.axon.taperrate.bifurcation.dependent.mean.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.taperrate.bifurcation.dependent.mean.singlebin.dependent = 'diameter';       
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.taperrate.bifurcation.dependent.mean.singlebin.fit = 'exponential'; %offset wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 3.436e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 9.377e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.axon.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = -3.961e-3;
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				input.axon.taperrate.bifurcation.dependent.sd.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.taperrate.bifurcation.dependent.sd.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.taperrate.bifurcation.dependent.sd.singlebin.fit = 'linear'; %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 7.691e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 7.918e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Skewness
				...
				input.axon.taperrate.bifurcation.dependent.skew.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.taperrate.bifurcation.dependent.skew.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.taperrate.bifurcation.dependent.skew.singlebin.fit = 'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = 0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = 0; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Kurtosis
				...
				input.axon.taperrate.bifurcation.dependent.kurt.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.taperrate.bifurcation.dependent.kurt.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.taperrate.bifurcation.dependent.kurt.singlebin.fit = 'linear'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = 0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = 3; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
...
% Termination Taper Rate
    ...
    % Termination Taper Rate dependency
		...
		input.axon.taperrate.termination.by = 'diameter';
        % Either 'diameter', 'surfacearea', or 'volume'

        input.axon.taperrate.termination.mode = 'dependent';
        % Either 'independent' or 'dependent'

		% Termination Taper Rate independent

			input.axon.taperrate.termination.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Termination Taper Rate dependent
			...
			% Termination Taper Rate Mean
				...
				input.axon.taperrate.termination.dependent.mean.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.taperrate.termination.dependent.mean.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.taperrate.termination.dependent.mean.singlebin.fit = 'exponential'; %offset wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.taperrate.termination.dependent.mean.singlebin.parameter(1) = 2.844e-2; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.taperrate.termination.dependent.mean.singlebin.parameter(2) = 5.399e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.axon.taperrate.termination.dependent.mean.singlebin.parameter(3) = -2.927e-2;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Termination Taper Rate Standard Deviation
				...
				input.axon.taperrate.termination.dependent.sd.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.taperrate.termination.dependent.sd.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.taperrate.termination.dependent.sd.singlebin.fit = 'linear'; %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.taperrate.termination.dependent.sd.singlebin.parameter(1) = 2.592e-4; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.taperrate.termination.dependent.sd.singlebin.parameter(2) = 1.178e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Skewness
				...
				input.axon.taperrate.termination.dependent.skew.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.taperrate.termination.dependent.skew.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.taperrate.termination.dependent.skew.singlebin.fit = 'linear'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.taperrate.termination.dependent.skew.singlebin.parameter(1) = 0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.taperrate.termination.dependent.skew.singlebin.parameter(2) = 0; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Kurtosis
				...
				input.axon.taperrate.termination.dependent.kurt.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.taperrate.termination.dependent.kurt.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.taperrate.termination.dependent.kurt.singlebin.fit = 'linear'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.taperrate.termination.dependent.kurt.singlebin.parameter(1) = 0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.taperrate.termination.dependent.kurt.singlebin.parameter(2) = 3; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
        ...
        input.axon.piecebifprob.mode = 'dependent';
        % Either 'independent' or 'dependent'

		% Piece Bifurcation Probability independent

			input.axon.piecebifprob.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				input.axon.piecebifprob.dependent.mean.by = 'length';
				% Either 'length', 'surface area' or 'volume'
				
				input.axon.piecebifprob.dependent.mean.type = 'doublebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.piecebifprob.dependent.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
						
						input.axon.piecebifprob.dependent.singlebin.fit = 'exponential';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
				...
				% Double Bin
					...
					input.axon.piecebifprob.dependent.doublebin.firstbin = 'diameter';
					input.axon.piecebifprob.dependent.doublebin.secondbin = 'pathlength';
					% Either 'diameter', 'pathlength', 'branchlength' or 'branchorder'
					
					input.axon.piecebifprob.dependent.doublebin.firstfit = 'power'; %off uw -- rw
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.axon.piecebifprob.dependent.doublebin.parameter(1).fit = 'exponential'; % rb 
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = 3.044e-6;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = 3.129e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.axon.piecebifprob.dependent.doublebin.parameter(2).fit = 'exponential'; %rb
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = 3.287e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = 3.424e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.axon.piecebifprob.dependent.doublebin.parameter(3).fit = 'exponential'; %rb
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.piecebifprob.dependent.doublebin.parameter(3).parameter(1) = 2.023e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.piecebifprob.dependent.doublebin.parameter(3).parameter(2) = 1.573e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.axon.piecebifprob.dependent.doublebin.parameter(4).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
...
% Piece Termination Probability
    ...
    % Piece Termination Probability dependency
        ...
        input.axon.piecetermprob.mode = 'dependent';
        % Either 'independent' or 'dependent'

		% Piece Termination Probability independent

			input.axon.piecetermprob.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				input.axon.piecetermprob.dependent.mean.by = 'length';
				% Either 'length', 'surface area' or 'volume'
				
				input.axon.piecetermprob.dependent.mean.type = 'doublebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.piecetermprob.dependent.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.piecetermprob.dependent.singlebin.fit = 'none'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
				...
				% Double Bin
					...
					input.axon.piecetermprob.dependent.doublebin.firstbin = 'diameter';
					input.axon.piecetermprob.dependent.doublebin.secondbin = 'pathlength';
					% Either 'diameter' or 'pathlength'
					
					input.axon.piecetermprob.dependent.doublebin.firstfit = 'power'; %rb -- initial
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.axon.piecetermprob.dependent.doublebin.parameter(1).fit = 'exponential';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.piecetermprob.dependent.doublebin.parameter(1).parameter(1) = 2.319e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.piecetermprob.dependent.doublebin.parameter(1).parameter(2) = 2.051e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.axon.piecetermprob.dependent.doublebin.parameter(2).fit = 'exponential';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.piecetermprob.dependent.doublebin.parameter(2).parameter(1) = -7.286e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.piecetermprob.dependent.doublebin.parameter(2).parameter(2) = -1.690e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.axon.piecetermprob.dependent.doublebin.parameter(3).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
						...
						input.axon.piecetermprob.dependent.doublebin.parameter(4).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
...
% Rall Ratio
    ...
    % Rall Ratio dependency
        ...
        input.axon.rallratio.mode = 'dependent';
        % Either 'independent' or 'dependent'

		% Rall Ratio independent

			input.axon.rallratio.distribution = 'pearson';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'

				input.axon.rallratio.const        = NaN;
				input.axon.rallratio.min          = 3.546e-1;
		...
		% Rall Ratio dependent
			...
			% Rall Ratio Mean
				...
				input.axon.rallratio.dependent.mean.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.rallratio.dependent.mean.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.rallratio.dependent.mean.singlebin.fit = 'exponential'; %off uw by piece
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.rallratio.dependent.mean.singlebin.parameter(1) = 1.723; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.rallratio.dependent.mean.singlebin.parameter(2) = -1.702; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.axon.rallratio.dependent.mean.singlebin.parameter(3) = 1.096; 
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Standard Deviation
				...
				input.axon.rallratio.dependent.sd.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.rallratio.dependent.sd.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.rallratio.dependent.sd.singlebin.fit = 'exponential'; %offset unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.rallratio.dependent.sd.singlebin.parameter(1) = 2.152e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.rallratio.dependent.sd.singlebin.parameter(2) = -1.502e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.axon.rallratio.dependent.sd.singlebin.parameter(3) = 2.665e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Skewness
				...
				input.axon.rallratio.dependent.skew.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.rallratio.dependent.skew.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.rallratio.dependent.skew.singlebin.fit = 'linear'; %uw %'exponential'; %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.rallratio.dependent.skew.singlebin.parameter(1) = 0; %-6.992e-2; %1.191e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.rallratio.dependent.skew.singlebin.parameter(2) = 0; %1.196e0; %-1.825e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.axon.rallratio.dependent.skew.singlebin.parameter(3) = NaN; %6.572e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Kurtosis
				...
				input.axon.rallratio.dependent.kurt.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.rallratio.dependent.kurt.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.rallratio.dependent.kurt.singlebin.fit = 'linear'; %'exponential'; %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.axon.rallratio.dependent.kurt.singlebin.parameter(1) = 0; %2.038e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.axon.rallratio.dependent.kurt.singlebin.parameter(2) = 3; %-1.012e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.axon.rallratio.dependent.kurt.singlebin.parameter(3) = NaN; %3.805e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
...
% Daughter Ratio
    ...
    % Daughter Ratio dependency
		...
		% Daughter Ratio independent
			...
			input.axon.daughterratio.distribution = 'gamma';
			...
			% The gamma distribution is for 'excess' daughter ratio (ratio - 1)
				...
				input.axon.daughterratio.min          = 1.0;
				input.axon.daughterratio.mean         = NaN; %1.818;
				input.axon.daughterratio.max          = NaN;
				input.axon.daughterratio.sd           = NaN; %0.9752;
				input.axon.daughterratio.skew         = NaN; %2.894;
				input.axon.daughterratio.kurt         = NaN; %15.36;
				
				input.axon.daughterratio.gamma.a      = 0.7035;
				input.axon.daughterratio.gamma.b      = 1.1628;
		
		% Daughter Ratio dependent
		
			% Daughter Ratio Mean
			
				input.axon.daughterratio.dependent.mean.type = 'none';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.daughterratio.dependent.mean.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.daughterratio.dependent.mean.singlebin.fit = 'none';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
			...
			% Daughter Ratio Standard Deviation
				...
				input.axon.daughterratio.dependent.sd.type = 'none';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.daughterratio.dependent.sd.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.daughterratio.dependent.sd.singlebin.fit = 'none';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
			...
			% Daughter Ratio Skewness
				...
				input.axon.daughterratio.dependent.skew.type = 'none';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.daughterratio.dependent.skew.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.daughterratio.dependent.skew.singlebin.fit = 'none';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
			...
			% Daughter Ratio Kurtosis
				...
				input.axon.daughterratio.dependent.kurt.type = 'none';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.axon.daughterratio.dependent.kurt.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.axon.daughterratio.dependent.kurt.singlebin.fit = 'none';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
...
% Meander angle
     ...
     input.dendrite.meanderangle.distribution = 'uniform';

        input.dendrite.meanderangle.const    = NaN;
        input.dendrite.meanderangle.min      = -1;
        input.dendrite.meanderangle.mean     = NaN;
        input.dendrite.meanderangle.max      = 1;
...
% Minimum dendritic diameter
    ...
    input.dendrite.mindendriticdiameter = 0.26;
...
% Bifurcation Taper Rate
    ...
    % Bifurcation Taper Rate dependency
		...
		input.dendrite.taperrate.bifurcation.by = 'diameter';
        % Either 'diameter', 'surfacearea', or 'volume'

        input.dendrite.taperrate.bifurcation.mode = 'dependent';
        % Either 'independent' or 'dependent'

		% Bifurcation Taper Rate independent

			input.dendrite.taperrate.bifurcation.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.bifurcation.dependent.mean.singlebin.fit = 'exponential'; %offset wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
...
% Termination Taper Rate
    ...
    % Termination Taper Rate dependency
		...
		input.dendrite.taperrate.termination.by = 'diameter';
        % Either 'diameter', 'surfacearea', or 'volume'
		...
		% Termination Taper Rate independent
			...
			input.dendrite.taperrate.termination.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
			...
			% Termination Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.termination.dependent.mean.singlebin.fit = 'exponential'; %offset wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
			...
			% Termination Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.termination.dependent.sd.singlebin.fit = 'linear'; %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
		...
		% Piece Bifurcation Probability independent
			...
			input.dendrite.piecebifprob.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				input.dendrite.piecebifprob.dependent.mean.by = 'length';
				% Either 'length', 'surface area' or 'volume'
				
				input.dendrite.piecebifprob.dependent.mean.type = 'doublebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.dendrite.piecebifprob.dependent.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
						
						input.dendrite.piecebifprob.dependent.singlebin.fit = 'exponential';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.piecebifprob.dependent.singlebin.parameter(1) = NaN;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.piecebifprob.dependent.singlebin.parameter(2) = NaN;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Double Bin
					...
					input.dendrite.piecebifprob.dependent.doublebin.firstfit = 'power'; %off uw -- rw
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.dendrite.piecebifprob.dependent.doublebin.parameter(1).fit = 'exponential'; % rb 
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
						...
						input.dendrite.piecebifprob.dependent.doublebin.parameter(2).fit = 'exponential'; %rb
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
						...
						input.dendrite.piecebifprob.dependent.doublebin.parameter(3).fit = 'exponential'; %rb
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
						...
						input.dendrite.piecebifprob.dependent.doublebin.parameter(4).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
...
% Piece Termination Probability
    ...
    % Piece Termination Probability dependency
		...
		% Piece Termination Probability independent
			...
			input.dendrite.piecetermprob.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				% Single Bin
					...
					input.dendrite.piecetermprob.dependent.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.dendrite.piecetermprob.dependent.singlebin.fit = 'none'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
				...
				% Double Bin
					...
					input.dendrite.piecetermprob.dependent.doublebin.firstfit = 'power'; %rb -- initial
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					   ...
					   input.dendrite.piecetermprob.dependent.doublebin.parameter(1).fit = 'exponential';
						...
						input.dendrite.piecetermprob.dependent.doublebin.parameter(3).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
						...
						input.dendrite.piecetermprob.dependent.doublebin.parameter(4).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
...
% Rall Ratio
    ...
    % Rall Ratio dependency
		...
		% Rall Ratio independent
			...
			input.dendrite.rallratio.distribution = 'pearson';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'

				input.dendrite.rallratio.const        = NaN;
				input.dendrite.rallratio.min          = 3.546e-1;
			...
			% Rall Ratio Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.rallratio.dependent.mean.singlebin.fit = 'exponential'; %off uw by piece
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
			...
			% Rall Ratio Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.rallratio.dependent.skew.singlebin.fit = 'linear'; %uw %'exponential'; %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.rallratio.dependent.skew.singlebin.parameter(1) = 0; %-6.992e-2; %1.191e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.rallratio.dependent.skew.singlebin.parameter(2) = 0; %1.196e0; %-1.825e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.dendrite.rallratio.dependent.skew.singlebin.parameter(3) = NaN; %6.572e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.rallratio.dependent.kurt.singlebin.fit = 'linear'; %'exponential'; %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.rallratio.dependent.kurt.singlebin.parameter(1) = 0; %2.038e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.rallratio.dependent.kurt.singlebin.parameter(2) = 3; %-1.012e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.dendrite.rallratio.dependent.kurt.singlebin.parameter(3) = NaN; %3.805e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
    ...
    % Daughter Ratio dependency
		...
		% Daughter Ratio independent
			...
			% The gamma distribution is for 'excess' daughter ratio (ratio - 1)
				...
				input.dendrite.daughterratio.mean         = NaN; %1.818;
				input.dendrite.daughterratio.max          = NaN;
				input.dendrite.daughterratio.sd           = NaN; %0.9752;
				input.dendrite.daughterratio.skew         = NaN; %2.894;
				input.dendrite.daughterratio.kurt         = NaN; %15.36;
		...
		% Daughter Ratio dependent
			...
			% Daughter Ratio Mean
				...
				input.dendrite.daughterratio.dependent.mean.type = 'none';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.dendrite.daughterratio.dependent.mean.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.dendrite.daughterratio.dependent.mean.singlebin.fit = 'none';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
			...
			% Daughter Ratio Standard Deviation
				...
				input.dendrite.daughterratio.dependent.sd.type = 'none';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.dendrite.daughterratio.dependent.sd.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.dendrite.daughterratio.dependent.sd.singlebin.fit = 'none';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
			...
			% Daughter Ratio Skewness
				...
				input.dendrite.daughterratio.dependent.skew.type = 'none';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.dendrite.daughterratio.dependent.skew.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.dendrite.daughterratio.dependent.skew.singlebin.fit = 'none';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
			...
			% Daughter Ratio Kurtosis
				...
				input.dendrite.daughterratio.dependent.kurt.type = 'none';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.dendrite.daughterratio.dependent.kurt.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.dendrite.daughterratio.dependent.kurt.singlebin.fit = 'none';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
...
% Number of trunks
   ...
   input.apical.numbertrunks.distribution = 'normal';
   % 'constant', 'uniform', 'normal', 'pearson', or 'preset'

        input.apical.numbertrunks.const        = NaN;
        input.apical.numbertrunks.min          = NaN;
        input.apical.numbertrunks.mean         = 3.594;
        input.apical.numbertrunks.max          = NaN;
        input.apical.numbertrunks.sd           = 1.316;
        input.apical.numbertrunks.skew         = 0.4618;
        input.apical.numbertrunks.kurt         = 3.216;
...
% Trunk diameters
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.apical.trunkdiameter.min      = 0;
        input.apical.trunkdiameter.mean     = 2.137;
        input.apical.trunkdiameter.max      = NaN;
        input.apical.trunkdiameter.sd       = 1.248;
        input.apical.trunkdiameter.skew     = 1.434;
        input.apical.trunkdiameter.kurt     = 5.230;
...
% Piece length
    ...
    input.apical.piecelength.distribution = 'constant';
        ...
        input.apical.piecelength.const    = 2;
...
% Meander angle
     ...
     input.apical.meanderangle.distribution = 'uniform';

        input.apical.meanderangle.const    = NaN;
        input.apical.meanderangle.min      = -1;
        input.apical.meanderangle.mean     = NaN;
        input.apical.meanderangle.max      = 1;
...
% Minimum dendritic diameter
    ...
    input.apical.mindendriticdiameter = 0.1;
...
% Bifurcation Taper Rate
    ...
    % Bifurcation Taper Rate dependency
		...
		input.apical.taperrate.bifurcation.by = 'diameter';
        % Either 'diameter', 'surfacearea', or 'volume'
		...
		% Bifurcation Taper Rate independent
			...
			input.apical.taperrate.bifurcation.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Bifurcation Taper Rate dependent
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.taperrate.bifurcation.dependent.mean.singlebin.fit = 'exponential'; %offset wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 3.436e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 9.377e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(3) = -3.961e-3;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				input.apical.taperrate.bifurcation.dependent.sd.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.taperrate.bifurcation.dependent.sd.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.taperrate.bifurcation.dependent.sd.singlebin.fit = 'linear'; %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 7.691e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 7.918e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Skewness
				...
				input.apical.taperrate.bifurcation.dependent.skew.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.taperrate.bifurcation.dependent.skew.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.taperrate.bifurcation.dependent.skew.singlebin.fit = 'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = 0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = 0; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Kurtosis
				...
				input.apical.taperrate.bifurcation.dependent.kurt.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.taperrate.bifurcation.dependent.kurt.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.taperrate.bifurcation.dependent.kurt.singlebin.fit = 'linear'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = 0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = 3; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
...
% Termination Taper Rate
    ...
    % Termination Taper Rate dependency
		...
		input.apical.taperrate.termination.by = 'diameter';
        % Either 'diameter', 'surfacearea', or 'volume'

        input.apical.taperrate.termination.mode = 'dependent';
        % Either 'independent' or 'dependent'

		% Termination Taper Rate independent

			input.apical.taperrate.termination.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Termination Taper Rate dependent
			...
			% Termination Taper Rate Mean
				...
				input.apical.taperrate.termination.dependent.mean.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.taperrate.termination.dependent.mean.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.taperrate.termination.dependent.mean.singlebin.fit = 'exponential'; %offset wt
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.termination.dependent.mean.singlebin.parameter(1) = 2.844e-2; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.termination.dependent.mean.singlebin.parameter(2) = 5.399e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.taperrate.termination.dependent.mean.singlebin.parameter(3) = -2.927e-2;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Termination Taper Rate Standard Deviation
				...
				input.apical.taperrate.termination.dependent.sd.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.taperrate.termination.dependent.sd.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.taperrate.termination.dependent.sd.singlebin.fit = 'linear'; %uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.termination.dependent.sd.singlebin.parameter(1) = 2.592e-4; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.termination.dependent.sd.singlebin.parameter(2) = 1.178e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Skewness
				...
				input.apical.taperrate.termination.dependent.skew.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.taperrate.termination.dependent.skew.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.taperrate.termination.dependent.skew.singlebin.fit = 'linear'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.termination.dependent.skew.singlebin.parameter(1) = 0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.termination.dependent.skew.singlebin.parameter(2) = 0; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Termination Taper Rate Kurtosis
				...
				input.apical.taperrate.termination.dependent.kurt.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.taperrate.termination.dependent.kurt.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.taperrate.termination.dependent.kurt.singlebin.fit = 'linear'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.termination.dependent.kurt.singlebin.parameter(1) = 0; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.termination.dependent.kurt.singlebin.parameter(2) = 3; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
		...
		% Piece Bifurcation Probability independent
			...
			input.apical.piecebifprob.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				input.apical.piecebifprob.dependent.mean.by = 'length';
				% Either 'length', 'surface area' or 'volume'
				
				input.apical.piecebifprob.dependent.mean.type = 'doublebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.piecebifprob.dependent.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
						
						input.apical.piecebifprob.dependent.singlebin.fit = 'exponential';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
				...
				% Double Bin
					...
					input.apical.piecebifprob.dependent.doublebin.firstbin = 'diameter';
					input.apical.piecebifprob.dependent.doublebin.secondbin = 'pathlength';
					% Either 'diameter', 'pathlength', 'branchlength' or 'branchorder'
					
					input.apical.piecebifprob.dependent.doublebin.firstfit = 'power'; %off uw -- rw
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.apical.piecebifprob.dependent.doublebin.parameter(1).fit = 'exponential'; % rb 
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.piecebifprob.dependent.doublebin.parameter(1).parameter(1) = 3.044e-6;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.piecebifprob.dependent.doublebin.parameter(1).parameter(2) = 3.129e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.apical.piecebifprob.dependent.doublebin.parameter(2).fit = 'exponential'; %rb
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.piecebifprob.dependent.doublebin.parameter(2).parameter(1) = 3.287e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.piecebifprob.dependent.doublebin.parameter(2).parameter(2) = 3.424e-4;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.apical.piecebifprob.dependent.doublebin.parameter(3).fit = 'exponential'; %rb
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.piecebifprob.dependent.doublebin.parameter(3).parameter(1) = 2.023e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.piecebifprob.dependent.doublebin.parameter(3).parameter(2) = 1.573e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.apical.piecebifprob.dependent.doublebin.parameter(4).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
...
% Piece Termination Probability
    ...
    % Piece Termination Probability dependency
        ...
        input.apical.piecetermprob.mode = 'dependent';
        % Either 'independent' or 'dependent'

		% Piece Termination Probability independent

			input.apical.piecetermprob.distribution = 'none';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				input.apical.piecetermprob.dependent.mean.by = 'length';
				% Either 'length', 'surface area' or 'volume'
				
				input.apical.piecetermprob.dependent.mean.type = 'doublebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.piecetermprob.dependent.singlebin.dependent = 'none';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.piecetermprob.dependent.singlebin.fit = 'none'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
				...
				% Double Bin
					...
					input.apical.piecetermprob.dependent.doublebin.firstbin = 'diameter';
					input.apical.piecetermprob.dependent.doublebin.secondbin = 'pathlength';
					% Either 'diameter' or 'pathlength'
					
					input.apical.piecetermprob.dependent.doublebin.firstfit = 'power'; %rb -- initial
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.apical.piecetermprob.dependent.doublebin.parameter(1).fit = 'exponential';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.piecetermprob.dependent.doublebin.parameter(1).parameter(1) = 2.319e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.piecetermprob.dependent.doublebin.parameter(1).parameter(2) = 2.051e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.apical.piecetermprob.dependent.doublebin.parameter(2).fit = 'exponential';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.piecetermprob.dependent.doublebin.parameter(2).parameter(1) = -7.286e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.piecetermprob.dependent.doublebin.parameter(2).parameter(2) = -1.690e-3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.apical.piecetermprob.dependent.doublebin.parameter(3).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
						...
						input.apical.piecetermprob.dependent.doublebin.parameter(4).fit = 'none';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'
...
% Rall Ratio
    ...
    % Rall Ratio dependency
		...
		% Rall Ratio independent
			...
			input.apical.rallratio.distribution = 'pearson';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'

				input.apical.rallratio.const        = NaN;
				input.apical.rallratio.min          = 3.546e-1;
		...
		% Rall Ratio dependent
			...
			% Rall Ratio Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.rallratio.dependent.mean.singlebin.fit = 'exponential'; %off uw by piece
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.rallratio.dependent.mean.singlebin.parameter(1) = 1.723; 
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.rallratio.dependent.mean.singlebin.parameter(2) = -1.702; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.rallratio.dependent.mean.singlebin.parameter(3) = 1.096; 
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Standard Deviation
				...
				input.apical.rallratio.dependent.sd.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.rallratio.dependent.sd.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.rallratio.dependent.sd.singlebin.fit = 'exponential'; %offset unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.rallratio.dependent.sd.singlebin.parameter(1) = 2.152e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.rallratio.dependent.sd.singlebin.parameter(2) = -1.502e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.rallratio.dependent.sd.singlebin.parameter(3) = 2.665e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Skewness
				...
				input.apical.rallratio.dependent.skew.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.rallratio.dependent.skew.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.rallratio.dependent.skew.singlebin.fit = 'linear'; %uw %'exponential'; %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.rallratio.dependent.skew.singlebin.parameter(1) = 0; %-6.992e-2; %1.191e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.rallratio.dependent.skew.singlebin.parameter(2) = 0; %1.196e0; %-1.825e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.rallratio.dependent.skew.singlebin.parameter(3) = NaN; %6.572e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Kurtosis
				...
				input.apical.rallratio.dependent.kurt.type = 'singlebin';
				% Either 'independent', 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.rallratio.dependent.kurt.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.rallratio.dependent.kurt.singlebin.fit = 'linear'; %'exponential'; %off uw
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.rallratio.dependent.kurt.singlebin.parameter(1) = 0; %2.038e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.rallratio.dependent.kurt.singlebin.parameter(2) = 3; %-1.012e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.rallratio.dependent.kurt.singlebin.parameter(3) = NaN; %3.805e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
    ...
    % Daughter Ratio dependency
		...
		% Daughter Ratio independent
			...
			% The gamma distribution is for 'excess' daughter ratio (ratio - 1)
				...
				input.apical.daughterratio.mean         = NaN; %1.818;
				input.apical.daughterratio.max          = NaN;
				input.apical.daughterratio.sd           = NaN; %0.9752;
				input.apical.daughterratio.skew         = NaN; %2.894;
				input.apical.daughterratio.kurt         = NaN; %15.36;
