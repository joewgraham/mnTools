...
% Trunk diameters
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.axon.trunkdiameter.min      = 0.12;
        input.axon.trunkdiameter.mean     = 2.345;
        input.axon.trunkdiameter.max      = 4.82;
        input.axon.trunkdiameter.sd       = 0.9071;
...
% Number of trunks
   ...
   % 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.dendrite.numbertrunks.mean         = 7.364;
        input.dendrite.numbertrunks.max          = NaN;
        input.dendrite.numbertrunks.sd           = 1.364;
        input.dendrite.numbertrunks.skew         = -0.2414;
        input.dendrite.numbertrunks.kurt         = 2.659;
		
		input.dendrite.numbertrunks.preset       = []; 
...
% Trunk diameters
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.dendrite.trunkdiameter.mean     = 2.069;
        input.dendrite.trunkdiameter.max      = NaN;
        input.dendrite.trunkdiameter.sd       = 1.117;
        input.dendrite.trunkdiameter.skew     = 2.967;
        input.dendrite.trunkdiameter.kurt     = 18.46;
		
		input.dendrite.trunkdiameter.preset{1} = [];
		input.dendrite.trunkdiameter.preset{2} = [];
		input.dendrite.trunkdiameter.preset{3} = [];
		input.dendrite.trunkdiameter.preset{4} = [];
...
% Piece length
    ...
    input.dendrite.piecelength.distribution = 'constant';
        ...
        input.dendrite.piecelength.const    = 2.0;
...
% Minimum dendritic diameter
    ...
    input.dendrite.mindiameter            = 0.07;
    input.dendrite.minbifurcationdiameter = 0.24;
    input.dendrite.resampleattempts       = 10;
    ...
    % Bifurcation Taper Rate dependency
		...
		% Bifurcation Taper Rate independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.dendrite.taperrate.bifurcation.const        = NaN; %0.001269;
				input.dendrite.taperrate.bifurcation.min          = NaN; %-1.416; 
				input.dendrite.taperrate.bifurcation.mean         = NaN; %0.001269;
				input.dendrite.taperrate.bifurcation.max          = NaN; %1.819; 
				input.dendrite.taperrate.bifurcation.sd           = NaN; %0.07698;
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.bifurcation.dependent.mean.singlebin.fit = 'power'; % rw 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 1.399e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 4.348e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.bifurcation.dependent.sd.singlebin.fit = 'power'; %robust weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 1.625e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 6.405e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.bifurcation.dependent.skew.singlebin.fit = 'linear'; %unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = 1.490;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = -4.587;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.bifurcation.dependent.kurt.singlebin.fit = 'power'; %unweighted  
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = 3.125e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = -5.624e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
    ...
    % Termination Taper Rate dependency
		...
		% Termination Taper Rate independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.dendrite.taperrate.termination.const        = 0.001860;
				input.dendrite.taperrate.termination.min          = NaN; %-4.957; 
				input.dendrite.taperrate.termination.mean         = NaN; %0.001860;
				input.dendrite.taperrate.termination.max          = NaN; %1.076; 
				input.dendrite.taperrate.termination.sd           = NaN; %0.08232;
...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
        ...
        input.dendrite.piecebifprob.mode = 'linearregress';
        % Either 'independent' or 'dependent'

		input.dendrite.piecebifprob.by = 'branchlength';
		% Either 'length', 'surface area' or 'volume'	
		...
		% Piece Bifurcation Probability independent
			...
			% Piece Bifurcation Probability linear regress

				input.dendrite.piecebifprob.linreg.constant        = 24.25;
				input.dendrite.piecebifprob.linreg.diameter        = -4.461;
				input.dendrite.piecebifprob.linreg.pathlength      = -0.05009;
				input.dendrite.piecebifprob.linreg.branchorder     = 3.827;
				input.dendrite.piecebifprob.linreg.diampathinter   = 0;

% Piece Bifurcation Probability dependent
		
			% Piece Bifurcation Probability
				
				input.dendrite.piecebifprob.dependent.mean.by = 'volume';
				% Either 'length', 'surface area' or 'volume'
				...
				% Single Bin
					...
					input.dendrite.piecebifprob.dependent.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
						
						input.dendrite.piecebifprob.dependent.singlebin.fit = 'power'; %offset unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.piecebifprob.dependent.singlebin.parameter(1) = 4.478e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.piecebifprob.dependent.singlebin.parameter(2) = -1.446e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.dendrite.piecebifprob.dependent.singlebin.parameter(3) = 1.993e-3;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
    ...
    % Piece Termination Probability dependency
		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				input.dendrite.piecetermprob.dependent.mean.by = 'volume';
				% Either 'length', 'surface area' or 'volume'
				
				input.dendrite.piecetermprob.dependent.mean.type = 'singlebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.dendrite.piecetermprob.dependent.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.dendrite.piecetermprob.dependent.singlebin.fit = 'power'; %unweighted 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.piecetermprob.dependent.singlebin.parameter(1) = 2.021e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.piecetermprob.dependent.singlebin.parameter(2) = -1.636e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Double Bin
					...
					input.dendrite.piecetermprob.dependent.doublebin.firstbin = '';
					input.dendrite.piecetermprob.dependent.doublebin.secondbin = '';
					% Either 'diameter' or 'pathlength'
					
					input.dendrite.piecetermprob.dependent.doublebin.firstfit = '';
					% Either 'linear', 'exponential', 'power' or 'sigmoid'
					
					   input.dendrite.piecetermprob.dependent.doublebin.parameter(1).fit = '';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.piecetermprob.dependent.doublebin.parameter(1).parameter(1) = NaN;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.piecetermprob.dependent.doublebin.parameter(1).parameter(2) = NaN;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
						...
						input.dendrite.piecetermprob.dependent.doublebin.parameter(2).fit = '';
						% Either 'linear, 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.piecetermprob.dependent.doublebin.parameter(2).parameter(1) = NaN;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.piecetermprob.dependent.doublebin.parameter(2).parameter(2) = NaN;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
    ...
    % Rall Ratio dependency
		...
		% Rall Ratio independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.dendrite.rallratio.min          = 0;
			...
			% Rall Ratio Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.rallratio.dependent.mean.singlebin.fit = 'power'; %offset unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.rallratio.dependent.mean.singlebin.parameter(1) = 2.036e2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.rallratio.dependent.mean.singlebin.parameter(2) = -2.618e-3; 
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.dendrite.rallratio.dependent.mean.singlebin.parameter(3) = -2.021e2; 
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.rallratio.dependent.sd.singlebin.fit = 'exponential'; %offset robust
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.rallratio.dependent.sd.singlebin.parameter(1) = 9.107e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.rallratio.dependent.sd.singlebin.parameter(2) = -9.753e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.dendrite.rallratio.dependent.sd.singlebin.parameter(3) = 2.070e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
...
% Trunk diameters
	...
	% 'constant', 'uniform', 'normal', 'pearson', or 'preset'
        ...
        input.apical.trunkdiameter.min      = 1.930;
        input.apical.trunkdiameter.mean     = 6.597;
        input.apical.trunkdiameter.max      = 10.06;
        input.apical.trunkdiameter.sd       = 1.888;
        input.apical.trunkdiameter.skew     = -0.4882;
        input.apical.trunkdiameter.kurt     = 3.182;
...
% Piece length
    ...
    input.apical.piecelength.distribution = 'constant';
        ...
        input.apical.piecelength.const    = 4;
...
% Meander angle
     ...
     input.apical.meanderangle.distribution = 'normal';
        ...
        input.apical.meanderangle.mean     = 0;
        input.apical.meanderangle.max      = NaN;
        input.apical.meanderangle.sd       = 5;
...
% Minimum dendritic diameter
    ...
    input.apical.mindiameter            = 0.1;
    input.apical.minbifurcationdiameter = 0.3387;
    input.apical.resampleattempts       = 10;
...
% Branch Type Probability
	...
	input.apical.probability.branch.mindiameter = 0.3387; 
	% Minimum value for bifurcation
	% Either NaN or numeric value
    ...
    input.apical.probability.branch.type = 'logit';
    % Either 'logit', 'probit', 'comploglog', or 'loglog'

    input.apical.probability.branch.parameter1 = -1.840; 
    % Non-multiplicative parameter in all cases
    input.apical.probability.branch.parameter2 = 1.889; 
    % Multiplicative parameter if mode is not doublebin
    % Diameter multiplicative parameter if mode is doublebin
    ...
    % Bifurcation Taper Rate dependency
		...
		% Bifurcation Taper Rate independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.apical.taperrate.bifurcation.const        = NaN; %0.001370;
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 4.575e-4;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 5.680e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.taperrate.bifurcation.dependent.sd.singlebin.fit = 'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 0.1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
    ...
    % Termination Taper Rate dependency
		...
		% Termination Taper Rate independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.apical.taperrate.termination.const        = 0.001705;
...
% Piece Bifurcation Probability
	...
	% Piece Bifurcation Probability dependency
		...
		input.apical.piecebifprob.mode = 'linearregress';
		% Either 'independent' or 'dependent'

		input.apical.piecebifprob.by = 'branchlength';
		% Either 'length', 'surface area' or 'volume'	
	...
	% Piece Bifurcation Probability linear regress
		...
		input.apical.piecebifprob.linreg.constant        = 40.11;
		input.apical.piecebifprob.linreg.diameter        = -0.01231;
		input.apical.piecebifprob.linreg.pathlength      = -0.01408;
		input.apical.piecebifprob.linreg.branchorder     = 1.908;
		input.apical.piecebifprob.linreg.diampathinter   = 0;

		% Piece Bifurcation Probability dependent
		
			% Piece Bifurcation Probability
				
				input.apical.piecebifprob.dependent.mean.by = 'volume';
				% Either 'length', 'surface area' or 'volume'
				
				input.apical.piecebifprob.dependent.mean.type = 'singlebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.piecebifprob.dependent.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
						
						input.apical.piecebifprob.dependent.singlebin.fit = 'power'; %unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.piecebifprob.dependent.singlebin.parameter(1) = 2.732e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.piecebifprob.dependent.singlebin.parameter(2) = -1.561e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
    ...
    % Piece Termination Probability dependency
		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				input.apical.piecetermprob.dependent.mean.by = 'volume';
				% Either 'length', 'surface area' or 'volume'
				
				input.apical.piecetermprob.dependent.mean.type = 'singlebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.piecetermprob.dependent.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.piecetermprob.dependent.singlebin.fit = 'power'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.piecetermprob.dependent.singlebin.parameter(1) = 1.732e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.piecetermprob.dependent.singlebin.parameter(2) = -2.050e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Rall Ratio Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.rallratio.dependent.sd.singlebin.fit = 'power'; %offset unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.rallratio.dependent.sd.singlebin.parameter(1) = 3.469e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.rallratio.dependent.sd.singlebin.parameter(2) = -1.667e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.apical.rallratio.dependent.sd.singlebin.parameter(3) = 1.578e-1;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
			...
			% Rall Ratio Skewness
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.rallratio.dependent.skew.singlebin.fit = 'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.rallratio.dependent.skew.singlebin.parameter(1) = 0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.rallratio.dependent.skew.singlebin.parameter(2) = 0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Rall Ratio Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.rallratio.dependent.kurt.singlebin.fit = 'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.rallratio.dependent.kurt.singlebin.parameter(1) = 0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.rallratio.dependent.kurt.singlebin.parameter(2) = 3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
...
% Daughter Ratio
    ...
    % Daughter Ratio dependency
        ...
        input.apical.daughterratio.mode = 'dependent';
        % Either 'independent' or 'dependent'
		...
		% Daughter Ratio dependent
			...
			% Daughter Ratio Mean
				...
				input.apical.daughterratio.dependent.mean.type = 'singlebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.daughterratio.dependent.mean.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.daughterratio.dependent.mean.singlebin.fit = 'linear'; %unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.daughterratio.dependent.mean.singlebin.parameter(1) = 4.027e-1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.daughterratio.dependent.mean.singlebin.parameter(2) = 1.132e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Daughter Ratio Standard Deviation
				...
				input.apical.daughterratio.dependent.sd.type = 'singlebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.daughterratio.dependent.sd.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.daughterratio.dependent.sd.singlebin.fit = 'linear'; %unweighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.daughterratio.dependent.sd.singlebin.parameter(1) = 6.722e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.daughterratio.dependent.sd.singlebin.parameter(2) = 7.930e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Daughter Ratio Skewness
				...
				input.apical.daughterratio.dependent.skew.type = 'singlebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.daughterratio.dependent.skew.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.daughterratio.dependent.skew.singlebin.fit = 'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.daughterratio.dependent.skew.singlebin.parameter(1) = 0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.daughterratio.dependent.skew.singlebin.parameter(2) = 0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Daughter Ratio Kurtosis
				...
				input.apical.daughterratio.dependent.kurt.type = 'singlebin';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.apical.daughterratio.dependent.kurt.singlebin.dependent = 'diameter';
					% Either 'diameter', 'pathlength' or 'radialdistance'
						
						input.apical.daughterratio.dependent.kurt.singlebin.fit = 'linear';
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.daughterratio.dependent.kurt.singlebin.parameter(1) = 0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.daughterratio.dependent.kurt.singlebin.parameter(2) = 3;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
