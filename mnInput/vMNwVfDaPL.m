		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				% Linear Regression by Branch Properties
                    ...
                    input.dendrite.piecebifprob.dependent.linreg.constant    = 6.314e2;
                    input.dendrite.piecebifprob.dependent.linreg.diameter    = 5.220e2;
                    input.dendrite.piecebifprob.dependent.linreg.pathlength  = -2.144e0;
		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				% Linear Regression by Branch Properties
                    ...
                    input.dendrite.piecetermprob.dependent.linreg.constant    = -4.551e2;
                    input.dendrite.piecetermprob.dependent.linreg.diameter    = 1.015e3;
                    input.dendrite.piecetermprob.dependent.linreg.pathlength  = -3.944e-1;
