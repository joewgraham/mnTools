...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
        ...
        input.dendrite.piecebifprob.by = 'branchvolume';
        % Either 'length', 'surface area' or 'volume'	
        ...
        input.dendrite.piecebifprob.linreg.constant        = 557.7;
        input.dendrite.piecebifprob.linreg.diameter        = 585.8;
        input.dendrite.piecebifprob.linreg.pathlength      = -0.4623;
        input.dendrite.piecebifprob.linreg.branchorder     = -63.11;
        input.dendrite.piecebifprob.linreg.diampathinter   = -0.5234;
