    ...
    % Piece Bifurcation Probability dependency
		...
		% Piece Bifurcation Probability independent
            ...
            % Or 'exponential' or 'gamma'
                ...
                input.dendrite.piecebifprob.exp          = NaN;
                input.dendrite.piecebifprob.gama         = NaN;
                input.dendrite.piecebifprob.gamb         = NaN;
		
		% Piece Bifurcation Probability dependent
		
			% Piece Bifurcation Probability
				
				input.dendrite.piecebifprob.dependent.type = 'linearregression';
				% Either 'linearregression', 'singlebin' or 'doublebin'
					
				% Linear Regression by Branch Properties
                
                    input.dendrite.piecebifprob.dependent.linreg.distribution = 'exponential';
                    
                    input.dendrite.piecebifprob.dependent.linreg.constant    = 3.221e2;
                    input.dendrite.piecebifprob.dependent.linreg.diameter    = -2.367e1;
                    input.dendrite.piecebifprob.dependent.linreg.pathlength  = -1.995e-1;
                    input.dendrite.piecebifprob.dependent.linreg.branchorder = 0;
...
% Piece Termination Probability
    ...
    % Piece Termination Probability dependency
        ...
        input.dendrite.piecetermprob.by = 'volume';
        % Either 'length', 'surfacearea', or 'volume'
		...
		% Piece Termination Probability independent
            ...
            % Or 'exponential' or 'gamma'
                ...
                input.dendrite.piecetermprob.exp          = NaN;
                input.dendrite.piecetermprob.gama         = NaN;
                input.dendrite.piecetermprob.gamb         = NaN;
		
		% Piece Termination Probability dependent
		
			% Piece Termination Probability
				
				input.dendrite.piecetermprob.dependent.type = 'linearregression';
				% Either 'linearregression', 'singlebin' or 'doublebin'
					
				% Linear Regression by Branch Properties
                
                    input.dendrite.piecetermprob.dependent.linreg.distribution = 'exponential';
                    
                    input.dendrite.piecetermprob.dependent.linreg.constant    = 2.155e2;
                    input.dendrite.piecetermprob.dependent.linreg.diameter    = 3.206e2;
                    input.dendrite.piecetermprob.dependent.linreg.pathlength  = -2.968e-1;
                    input.dendrite.piecetermprob.dependent.linreg.branchorder = 0;
