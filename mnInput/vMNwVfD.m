		...
		% Piece Bifurcation Probability dependent
			...
			% Piece Bifurcation Probability
				...
				% Linear Regression by Branch Properties
                    ...
                    input.dendrite.piecebifprob.dependent.linreg.constant    = -7.673e2;
                    input.dendrite.piecebifprob.dependent.linreg.diameter    = 6.914e2;
                    input.dendrite.piecebifprob.dependent.linreg.pathlength  = 0;
		...
		% Piece Termination Probability dependent
			...
			% Piece Termination Probability
				...
				% Linear Regression by Branch Properties
                    ...
                    input.dendrite.piecetermprob.dependent.linreg.constant    = -7.691e2;
                    input.dendrite.piecetermprob.dependent.linreg.diameter    = 1.051e3;
                    input.dendrite.piecetermprob.dependent.linreg.pathlength  = 0;
