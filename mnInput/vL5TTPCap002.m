...
% Branch Type Probability
	...
	input.apical.probability.branch.maxpathlength = 1000; 
	% Maximum value for bifurcation
	% Either NaN or numeric value
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.taperrate.bifurcation.dependent.mean.singlebin.fit = 'linear'; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

                            input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 0.075;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = -0.25;
                        	% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
    ...
    % Piece Bifurcation Probability dependency
        ...
        % Either 'singlebin' or 'doublebin'
                ...
                % Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
                    ...
                    input.apical.piecebifprob.dependent.singlebin.fit = 'exponential'; %unweighted
                    % Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

                        input.apical.piecebifprob.dependent.singlebin.parameter(1) = 8.763e-4;
                        % Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
                        input.apical.piecebifprob.dependent.singlebin.parameter(2) = 2.832e-3;
                        % Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
...
% Rall Ratio
    ...
    % Rall Ratio dependency
		...
		% Rall Ratio independent
			...
			input.apical.rallratio.distribution = 'lognormal';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'

				input.apical.rallratio.const        = NaN;
				input.apical.rallratio.min          = 0.1361;
				input.apical.rallratio.mean         = 0.4228;
				input.apical.rallratio.max          = NaN; 
				input.apical.rallratio.sd           = 0.4273; 
