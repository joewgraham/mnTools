    ...
    % Bifurcation Taper Rate dependency
		...
		% Bifurcation Taper Rate independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.dendrite.taperrate.bifurcation.const        = 0.001269;
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.bifurcation.dependent.mean.singlebin.fit = 'linear'; % piecewise unweighted 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 3.030e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = -3.196e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.bifurcation.dependent.sd.singlebin.fit = 'linear'; %constant
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 0.1753;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
							...
							input.dendrite.taperrate.bifurcation.dependent.skew.singlebin.parameter(1) = 1.490e0;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.taperrate.bifurcation.dependent.skew.singlebin.parameter(2) = -4.589e0;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Kurtosis
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.dendrite.taperrate.bifurcation.dependent.kurt.singlebin.fit = 'power'; %offset unweighted 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.dendrite.taperrate.bifurcation.dependent.kurt.singlebin.parameter(1) = 3.710e1;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.dendrite.taperrate.bifurcation.dependent.kurt.singlebin.parameter(2) = -5.018e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
							input.dendrite.taperrate.bifurcation.dependent.kurt.singlebin.parameter(3) = -5.250e0;
							% Linear: N/A | Exponential: N/A | Power: N/A | Sigmoidal: halfmax
...
% Piece Bifurcation Probability
    ...
    % Piece Bifurcation Probability dependency
        ...
        input.dendrite.piecebifprob.mode = 'independent';
        % Either 'independent' or 'dependent'
		...
		% Piece Bifurcation Probability independent
            ...
            input.dendrite.piecebifprob.distribution = 'exponential';
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
            % Or 'exponential'
                ...
                input.dendrite.piecebifprob.mu           = 30.47;
		
		% Piece Bifurcation Probability dependent
		
			% Piece Bifurcation Probability
				
				input.dendrite.piecebifprob.dependent.mean.by = '';
				% Either 'length', 'surface area' or 'volume'
				
				input.dendrite.piecebifprob.dependent.mean.type = '';
				% Either 'singlebin' or 'doublebin'
					
				% Single Bin
				
					input.dendrite.piecebifprob.dependent.singlebin.dependent = '';
					% Either 'diameter', 'pathlength', 'radialdistance' or 'branchlength'
						
						input.dendrite.piecebifprob.dependent.singlebin.fit = ''; 
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'
    ...
    % Bifurcation Taper Rate dependency
		...
		% Bifurcation Taper Rate independent
			...
			% Either 'constant', 'uniform', 'normal', 'pearson', or 'none'
				...
				input.apical.taperrate.bifurcation.const        = 0.001370;
			...
			% Bifurcation Taper Rate Mean
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.taperrate.bifurcation.dependent.mean.singlebin.fit = 'exponential'; %weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(1) = 1.082e-3;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.mean.singlebin.parameter(2) = 4.833e-1;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
			...
			% Bifurcation Taper Rate Standard Deviation
				...
				% Single Bin
					...
					% Either 'diameter', 'pathlength' or 'radialdistance'
						...
						input.apical.taperrate.bifurcation.dependent.sd.singlebin.fit = 'linear'; %weighted
						% Either 'linear', 'exponential', 'power', 'sigmoidal' or 'none'

							input.apical.taperrate.bifurcation.dependent.sd.singlebin.parameter(1) = 1.600e-2;
							% Linear: m | Exponential: a | Power: a | Sigmoidal: minasym
							input.apical.taperrate.bifurcation.dependent.sd.singlebin.parameter(2) = 9.151e-2;
							% Linear: b | Exponential: b | Power: b | Sigmoidal: maxasym
