...
% ________________________________________________________________________
% Fit Branch Types
    option.mnfitter.axon     = 'y';
    option.mnfitter.dendrite = 'y';
    option.mnfitter.apical   = 'y';
% ________________________________________________________________________
...
%       Explore Piecewise Mean?
         option.mnfitter.taperrate.piece = 'y';         
%
%     Explore Single Bins
%		Explore Diameter? 	
...
%       Explore Radial Distance?
          option.mnfitter.taperrate.radialdistance.fit = 'y';
%       Explore Branch Length?
          option.mnfitter.taperrate.branchlength.fit = 'y';
%       Explore Branch Order?
          option.mnfitter.taperrate.branchorder.fit = 'y';
%	  
%	  Fit Single Bins?
...
%       Length?
         option.mnfitter.piecebifprob.bylength = 'y';
%       Surface Area?
         option.mnfitter.piecebifprob.bysurfacearea = 'y';
%       Volume?
...
%       Explore Radial Distance?
          option.mnfitter.piecebifprob.radialdistance.fit = 'y';
%       Explore Branch Length?
          option.mnfitter.piecebifprob.branchlength.fit = 'y';
%       Explore Branch Order?
          option.mnfitter.piecebifprob.branchorder.fit = 'y';
%
%	  Fit Single Bins?
...
%      Explore Calculated by
%       Length?
         option.mnfitter.piecetermprob.bylength = 'y';
%       Surface Area?
         option.mnfitter.piecetermprob.bysurfacearea = 'y';
%       Volume?
...
%       Explore Radial Distance?
          option.mnfitter.piecetermprob.radialdistance.fit = 'y';
%       Explore Branch Length?
          option.mnfitter.piecetermprob.branchlength.fit = 'y';
%       Explore Branch Order?
          option.mnfitter.piecetermprob.branchorder.fit = 'y';
...
%       Explore Radial Distance?
          option.mnfitter.rallratio.radialdistance.fit = 'y';
%       Explore Branch Length?
          option.mnfitter.rallratio.branchlength.fit = 'y';
%       Explore Branch Order?
          option.mnfitter.rallratio.branchorder.fit = 'y';
%
%	  Fit Single Bins?
...
%       Fit Radial Distance?
          option.mnfitter.daughterratio.radialdistance.fit = 'y';
%       Fit Branch Length?
          option.mnfitter.daughterratio.branchlength.fit = 'y';
%       Fit Branch Order?
          option.mnfitter.daughterratio.branchorder.fit = 'y';
%
%	  Fit Single Bins?
