...
maxpathlengthbin = ceil(max([data.individual.maxpathlength]) / data.distancebinwidth);
...
maxbranchlengthbin = ceil(max([data.individual.maxbranchlength]) / data.branchlengthbinwidth);
...
% For every motoneuron in the population, do the following:
    ...
    % For every piece in this motoneuron, do the following:
        ...
        currentdistalpathlengthbin       = ceil(currentdistalpathlength / data.distancebinwidth);
			if currentdistalpathlengthbin == 0; currentdistalpathlengthbin = 1; end;
        ...
        currentdistalradialdistancebin   = ceil(currentdistalradialdistance / data.distancebinwidth);
			if currentdistalradialdistancebin == 0; currentdistalradialdistancebin = 1; end;
        ...
        currentdistalbranchlengthbin       = ceil(currentdistalbranchlength / data.branchlengthbinwidth);
			if currentdistalbranchlengthbin == 0; currentdistalbranchlengthbin = 1; end;
