function [data,analysis] = daughterdirectionanalyzer(data,analysis)

disp('   Daughter direction analysis started.');
...
%                         typeanalysis.bifurcation.cable.proximaltaperrate.values(numberofcables)            = inddata.cablebins(j).proximaltaperrate;
%                         typeanalysis.bifurcation.cable.distaltaperrate.values(numberofcables)              = inddata.cablebins(j).distaltaperrate;
...
%                         numberofbifurcations = numberofbifurcations + 1;
%                         
%                         %typeanalysis.cable.rallratio.values(numberofbifurcations)            = [];
%                         %typeanalysis.cable.rallratio1.values(numberofbifurcations)           = [];
%                         %typeanalysis.cable.rallratio2.values(numberofbifurcations)           = [];
%                         %typeanalysis.cable.rallratio3.values(numberofbifurcations)           = [];
%                         %typeanalysis.cable.daughter1diameter.values(numberofbifurcations)    = [];
%                         %typeanalysis.cable.daughter2diameter.values(numberofbifurcations)    = [];
%                         %typeanalysis.cable.daughterratio.values(numberofbifurcations)        = [];
%                         %typeanalysis.cable.parentdaughterratio.values(numberofbifurcations)  = [];
%                         %typeanalysis.cable.parentdaughter2ratio.values(numberofbifurcations) = [];
%                         
%                         typeanalysis.bifurcation.cable.branchorder.values(numberofbifurcations)            = inddata.cablebins(j).branchorder;
%                         typeanalysis.bifurcation.cable.degree.values(numberofbifurcations)                 = inddata.cablebins(j).degree;
%                         typeanalysis.bifurcation.cable.proximaldiameter.values(numberofbifurcations)       = inddata.cablebins(j).proximaldiameter;
...
%                         %typeanalysis.bifurcation.cable.rallratio.values(numberofbifurcations)              = [];
%                         %typeanalysis.bifurcation.cable.rallratio1.values(numberofbifurcations)             = [];
%                         %typeanalysis.bifurcation.cable.rallratio2.values(numberofbifurcations)             = [];
%                         %typeanalysis.bifurcation.cable.rallratio3.values(numberofbifurcations)             = [];
%                         %typeanalysis.bifurcation.cable.daughter1diameter.values(numberofbifurcations)      = [];
%                         %typeanalysis.bifurcation.cable.daughter2diameter.values(numberofbifurcations)      = [];
%                         %typeanalysis.bifurcation.cable.daughterratio.values(numberofbifurcations)          = [];
%                         %typeanalysis.bifurcation.cable.parentdaughterratio.values(numberofbifurcations)    = [];
%                         %typeanalysis.bifurcation.cable.parentdaughter2ratio.values(numberofbifurcations)   = [];
%                         
%                         typeanalysis.bifurcation.cable.partitionasymmetry.values(numberofbifurcations)     = inddata.cablebins(j).partitionasymmetry;
%                         typeanalysis.bifurcation.cable.surfaceasymmetry.values(numberofbifurcations)       = inddata.cablebins(j).surfaceasymmetry;
%                         
