function [parameter,rmse]=exponentialfitterrobustweighted(x,y,varargin)
...
if nargin > 2
    parameter = fminsearch(@(parameter) exponentialrmseweighted(x,y,weights,parameter) , parameter , optimset('Display','off'));
    parameter = fminsearch(@(parameter) exponentiallorentzianweighted(x,y,weights,parameter) , parameter , optimset('Display','off'));
