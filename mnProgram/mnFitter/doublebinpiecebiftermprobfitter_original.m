...
for f = 1:length(branches)
    ...
    firstbins  = {'diameter','pathlength','branchlength'};
    firstbinslabels = {'Diameter (\mum)','Path Length from Soma (\mum)','Intra-Branch Length (\mum)'};
    firstbinstitles = {'Diameter','Path Length','Branch Length'};
    firstbinstokeep = [false false false];
    eval(['currentoption = mnfitteroption.' branchname ';']);
    if strcmp(currentoption.diameter.pathlength,'y') || strcmp(currentoption.diameter.branchlength,'y')
	...
	secondbins  = {'pathlength','diameter','branchlength'};
    secondbinslabels = {'Path Length from Soma (\mum)','Diameter (\mum)','Intra-Branch Length (\mum)'};
    secondbinstitles = {'Path Length','Diameter','Branch Length'};
	secondbinstokeep = [false false false];
	if strcmp(currentoption.diameter.pathlength,'y')
        secondbinstokeep(1) = true;
    end
    if strcmp(currentoption.pathlength.diameter,'y') || strcmp(currentoption.branchlength.diameter,'y')
					...
					for i = 1:length(bys)
						...
						if strcmp(pooled,'y') == 1
							if strcmp(firstbin,'diameter') == 1
								eval(['firstbindataraw2 = [analysis.doublebin.' firstbin secondbin '.' firstbin '];']);
								eval(['secondbindataraw2 = [analysis.doublebin.' firstbin secondbin '.' secondbin '];']);
								eval(['measuredataraw2 = [analysis.doublebin.' firstbin secondbin '.' branch 'probability.by' by '];']);
								%eval(['weightdataraw2 = [analysis.doublebin.' by '];']);
								%eval(['weightdataraw2 = [analysis.doublebin.numberbifurcations]+[analysis.doublebin.numberterminations];']);
								eval(['weightdataraw2 = [analysis.doublebin.' firstbin secondbin '.numbersegments];']);
							elseif strcmp(firstbin,'pathlength') == 1 || strcmp(firstbin,'branchlength') == 1
								eval(['firstbindataraw2 = [analysis.doublebin.' secondbin firstbin '.' firstbin ']'';']);
								eval(['secondbindataraw2 = [analysis.doublebin.' secondbin firstbin '.' secondbin ']'';']);
								eval(['measuredataraw2 = [analysis.doublebin.' secondbin firstbin '.' branch 'probability.by' by ']'';']);
								%eval(['weightdataraw2 = [analysis.doublebin.' by ']'';']);
								%eval(['weightdataraw2 = [analysis.doublebin.numberbifurcations]+[analysis.doublebin.numberterminations]'';']);
								eval(['weightdataraw2 = [analysis.doublebin.' secondbin firstbin '.numbersegments]'';']);
							else
						...
						elseif strcmp(pooled,'n') == 1
							if strcmp(firstbin,'diameter') == 1
								eval(['firstbindataraw2 = [analysis.' branch '.doublebin.' firstbin secondbin '.' firstbin '];']);
								eval(['secondbindataraw2 = [analysis.' branch '.doublebin.' firstbin secondbin '.' secondbin '];']);
								eval(['measuredataraw2 = [analysis.' branch '.doublebin.' firstbin secondbin '.' branch 'probability.by' by '];']);
								%eval(['weightdataraw2 = [analysis.' branch '.doublebin.' by '];']);
								%eval(['weightdataraw2 = [analysis.' branch '.doublebin.number' branch 's];']);
								eval(['weightdataraw2 = [analysis.' branch '.doublebin.' firstbin secondbin '.numbersegments];']);
							elseif strcmp(firstbin,'pathlength') == 1 || strcmp(firstbin,'branchlength') == 1
								eval(['firstbindataraw2 = [analysis.' branch '.doublebin.' secondbin firstbin '.' firstbin ']'';']);
								eval(['secondbindataraw2 = [analysis.' branch '.doublebin.' secondbin firstbin '.' secondbin ']'';']);
								eval(['measuredataraw2 = [analysis.' branch '.doublebin.' secondbin firstbin '.' branch 'probability.by' by ']'';']);
								%eval(['weightdataraw2 = [analysis.' branch '.doublebin.' by ']'';']);
								%eval(['weightdataraw2 = [analysis.' branch '.doublebin.number' branch 's]'';']);
								eval(['weightdataraw2 = [analysis.' branch '.doublebin.' secondbin firstbin '.numbersegments]'';']);
							else
						...
						if strcmp(currentoption.doublebins.fit,'y')
							...
							ylabel(secondbinlabel,'FontSize',8,'FontWeight','b');
							zlabel([branchlabel ' Probability'],'FontSize',8,'FontWeight','b');
							title(char(' ',[branchlabel ' Probability by ' bylabel ' vs ' firstbintitle ' & ' secondbintitle ' -- Robust Unweighted Fit'],' '),'FontSize',12,'FontWeight','b');
							set(gca,'FontSize',6);
							legendhandle1 = legendhandle1(1);
							legendhandles = [legendhandle1 legendhandle2];
							legendtext1 = char(' ',sprintf('%s Data',analysis.inputfilename),' ');
							...
							legendtext(2) = {legendtextprep};
							legend(legendhandles,legendtext,'Location','NorthEast');
							filename = sprintf('%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_uwr',analysis.inputfilename,branchname,by,firstbin,filename1,filename2,filename3,filename4,filename5,filename6);
							saveas(gcf,filename,'fig');
							print('-djpeg',filename);
							set(gca,'ZScale','log');
							filename = sprintf('%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_uwr_lz',analysis.inputfilename,branchname,by,firstbin,filename1,filename2,filename3,filename4,filename5,filename6);
							print('-djpeg',filename);
							set(gca,'XScale','log');
							filename = sprintf('%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_uwr_lz_lx',analysis.inputfilename,branchname,by,firstbin,filename1,filename2,filename3,filename4,filename5,filename6);
							print('-djpeg',filename);
							...
							ylabel(secondbinlabel,'FontSize',8,'FontWeight','b');
							zlabel([branchlabel ' Probability'],'FontSize',8,'FontWeight','b');
							title(char(' ',[branchlabel ' Probability by ' bylabel ' vs ' firstbintitle ' & ' secondbintitle ' -- Robust Weighted Fit'],' '),'FontSize',12,'FontWeight','b');
							set(gca,'FontSize',6);
							legendhandle1 = legendhandle1(1);
							legendhandles = [legendhandle1 legendhandle2];
							legendtext1 = char(' ',sprintf('%s Data',analysis.inputfilename),' ');
							...
							legendtext(2) = {legendtextprep};
							legend(legendhandles,legendtext,'Location','NorthEast');
							filename = sprintf('%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_wr',analysis.inputfilename,branchname,by,firstbin,filename1,filename2,filename3,filename4,filename5,filename6);
							saveas(gcf,filename,'fig');
							print('-djpeg',filename);
							set(gca,'ZScale','log');
							filename = sprintf('%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_wr_lz',analysis.inputfilename,branchname,by,firstbin,filename1,filename2,filename3,filename4,filename5,filename6);
							print('-djpeg',filename);
							set(gca,'XScale','log');
							filename = sprintf('%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_wr_lz_lx',analysis.inputfilename,branchname,by,firstbin,filename1,filename2,filename3,filename4,filename5,filename6);
							print('-djpeg',filename);
							if strcmp(mnfitteroption.figuresopen,'n'); close all; end;
						end
					end
