        ...
        for g = 1:length(measures)
            ...
            for h = 1:length(versuses)
                ...
                for i = 1:length(statistics)
                    ...
                    set(gca,'FontSize',6);
                    filename = sprintf('%s_1_%s_%s_%s_vs_%s',analysis.inputfilename,piecetitles{piecetype},measure,statistic,versus);
                    print('-djpeg',filename);
                    set(gca,'YScale','log');
                    filename = sprintf('%s_1_%s_%s_%s_vs_%s_logy',analysis.inputfilename,piecetitles{piecetype},measure,statistic,versus);
                    print('-djpeg',filename);
                    set(gca,'XScale','log');
                    filename = sprintf('%s_1_%s_%s_%s_vs_%s_logy_logx',analysis.inputfilename,piecetitles{piecetype},measure,statistic,versus);
                    print('-djpeg',filename);
                    ...
                    if strcmp(currentoption.singlebins,'y') == 1
                        ...
                        for j = 1:length(fits)
                            ...
                            try
                                ...
                                disp(' ');
                                disp('   Warning: not able to perform fit (singlebinpooledtaperratefitter).');
                                disp(' ');
                                continue
                            end
