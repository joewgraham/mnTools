function parameterfits = doublebinbiftermtaperratefitter(analysis,parameterfits,mnfitteroption)

disp('     Double Bin Bif/Term Taper Rate.');
%mnfitteroptions;
...
for piecetype = 2:4
    ...
    if isfield(analysis,piecetypes{piecetype}) && strcmp(fittypeoption,'y')
        ...
        branchesfilenames = branchesfilenames(branchestokeep);
        ...
        for f = 1:length(branches)
            ...
            for g = 1:length(secondbins)
                ...
                for h = 1:length(firstbins)
                    ...
                    if ~strcmp(firstbin,secondbin)
                        
                        if strcmp(firstbin,'diameter') || strcmp(secondbin,'diameter')
                            ...
                            for i = 1:length(statistics)
                                ...
                                if strcmp(firstbin,'diameter') == 1
                                    ...
                                    eval(['measuredataraw2 = [typeanalysis.' branch '.doublebin.' firstbin secondbin '.' measure '.' statistic '];']);
                                ...
                                elseif strcmp(firstbin,'pathlength') == 1 || strcmp(firstbin,'branchlength') == 1 || strcmp(firstbin,'branchorder') == 1
                                    ...
                                    eval(['measuredataraw2 = [typeanalysis.' branch '.doublebin.' secondbin firstbin '.' measure '.' statistic ']'';']);
                                ...
                                counter = 0;
                                for rows=1:size(measuredataraw2(:,1),1)
                                ...
                                counter = 0;
                                for columns=1:size(measuredataraw(1,:),2)
                                ...
                                zlabel([branchlabel ' ' measurelabel ' ' statisticlabel],'FontSize',8,'FontWeight','b');
                                title(char(' ',[piecetitles{piecetype} ' ' branchlabel ' ' measurelabel ' ' statisticlabel  ' vs ' firstbintitle ' & ' secondbintitle],' '),'FontSize',12,'FontWeight','b');
                                set(gca,'FontSize',6);
                                ...
                                filename = sprintf('%s_%s_2_DoubleBin_%s_%s_%s_vs_%s_&_%s',analysis.inputfilename,piecetitles{piecetype},branch,measure,statistic,firstbin,secondbin);
                                saveas(gcf,filename,'fig');
                                print('-djpeg',filename);
                                set(gca,'ZScale','log');
                                filename = sprintf('%s_%s_2_DoubleBin_%s_%s_%s_vs_%s_&_%s_logz',analysis.inputfilename,piecetitles{piecetype},branch,measure,statistic,firstbin,secondbin);
                                print('-djpeg',filename);
                                set(gca,'XScale','log');
                                filename = sprintf('%s_%s_2_DoubleBin_%s_%s_%s_vs_%s_&_%s_logz_logx',analysis.inputfilename,piecetitles{piecetype},branch,measure,statistic,firstbin,secondbin);
                                print('-djpeg',filename);
                                        ...
                                        for k = 1:length(fittypes)
                                            ...
                                            for measurecolumn = 1:size(measuredata,2)
                                                ...
                                                if (sum(~isnan(y))-length(y(y==0))) > 2
                                                    ...
                                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.parametervalues(' num2str(fitcount) ',:) = parameter;']);
                                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.rmse(' num2str(fitcount) ',:) = rmse(1);']);
                                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.wrmse(' num2str(fitcount) ',:) = rmse(2);']);
                                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.weight(' num2str(fitcount) ',:) = ' num2str(sum(weight)) ';']);
                                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.' secondbin '(' num2str(fitcount) ',:) = ' num2str(x2(1,1)) ';']);
                                            ...
                                            eval(['meanrmse = mean([parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.rmse]);']);
                                            eval(['totalrmse = sum([parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.rmse]);']);
                                            eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.meanrmse = meanrmse;']);
                                            eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.totalrmse = totalrmse;']);
                                            eval(['meanwrmse = mean([parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.wrmse]);']);
                                            eval(['totalwrmse = sum([parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.wrmse]);']);
                                            eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.meanwrmse = meanwrmse;']);
                                            eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.totalwrmse = totalwrmse;']);
                                            
                                            %fillscreen;
                                            xlabel(firstbinlabel,'FontSize',8,'FontWeight','b');
                                            ylabel(secondbinlabel,'FontSize',8,'FontWeight','b');
                                            zlabel([branchlabel ' ' measurelabel ' ' statisticlabel],'FontSize',8,'FontWeight','b');
                                            title(char(' ',[piecetitles{piecetype} ' ' branchlabel ' ' measurelabel ' ' statisticlabel  ' vs ' firstbintitle ' -- ' fitlabel ' ' fittypelabel],' '),'FontSize',12,'FontWeight','b');
                                            set(gca,'FontSize',6);
                                            ...
                                            filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s',analysis.inputfilename,piecetitles{piecetype},branch,measure,statistic,firstbin,secondbin,fitfilename,fittypefilename);
                                            print('-djpeg',filename);
                                            set(gca,'ZScale','log');
                                            filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_logz',analysis.inputfilename,piecetitles{piecetype},branch,measure,statistic,firstbin,secondbin,fitfilename,fittypefilename);
                                            print('-djpeg',filename);
                                            set(gca,'XScale','log');
                                            filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_logz_logx',analysis.inputfilename,piecetitles{piecetype},branch,measure,statistic,firstbin,secondbin,fitfilename,fittypefilename);
                                            print('-djpeg',filename);
                                            ...
                                            if strcmp(currentoption.secondbinfit.fit,'y')
                                                ...
                                                for m = 1:length(parameter)
                                                    ...
                                                    eval(['x = [parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.' secondbin '];']);
                                                    eval(['y = [parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.parametervalues(:,' num2str(m) ')];']);
                                                    eval(['weight = [parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.weight];']);
                                                    weight = weight(isfinite(y));
                                                    x      = x(isfinite(y));
                                                    y      = y(isfinite(y));
                                                    ...
                                                    for n = 1:length(secondfits)
                                                        ...
                                                        title(char(' ',[piecetitles{piecetype} ' ' branchlabel ' ' measurelabel ' ' statisticlabel ' vs ' firstbintitle ' -- ' fitlabel ' ' fittypelabel],[parametertitle ' vs ' secondbintitle ' -- ' secondfitlabel ' Fits'],' '),'FontSize',12,'FontWeight','b');
                                                        set(gca,'FontSize',6);
                                                        hold on;
                                                        ...
                                                        for o = 1:length(secondfittypes)
                                                            ...
                                                            eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.parameter(' num2str(m) ').' secondfit '.' secondfittype '.parametervalues = parameter;']);
                                                            eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' fit '.' fittype '.parameter(' num2str(m) ').' secondfit '.' secondfittype '.rmse = rmse;']);
                                                        ...
                                                        clear legendtext;
                                                        filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_P%d_%s',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,fitfilename,fittypefilename,m,secondfitfilename);
                                                        print('-djpeg',filename);
                                                        set(gca,'YScale','log');
                                                        filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_P%d_%s_logy',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,fitfilename,fittypefilename,m,secondfitfilename);
                                                        print('-djpeg',filename);
                                                        set(gca,'XScale','log');
                                                        filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_P%d_%s_logy_logx',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,fitfilename,fittypefilename,m,secondfitfilename);
                                                        print('-djpeg',filename);
                                                        if strcmp(mnfitteroption.figuresopen,'n'); close all; end;
                                ...
                                if strcmp(currentoption.doublebins.fit,'y')
                                    ...
                                    eval(['doublefit.parameter(1).parameter = parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.firstbin.fittype '.parameter(1).' currentoption.doublebins.parameter(1).fit '.' currentoption.doublebins.parameter(1).fittype '.parametervalues;']);
                                    doublefit.parameter(2).fit = currentoption.doublebins.parameter(2).fit;
                                    eval(['doublefit.parameter(2).parameter = parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.firstbin.fittype '.parameter(2).' currentoption.doublebins.parameter(2).fit '.' currentoption.doublebins.parameter(2).fittype '.parametervalues;']);
                                    if strcmp(currentoption.doublebins.parameter(3).fit,'none')~=1
                                        ...
                                        eval(['doublefit.parameter(3).parameter = parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.firstbin.fittype '.parameter(3).' currentoption.doublebins.parameter(3).fit '.' currentoption.doublebins.parameter(3).fittype '.parametervalues;']);
                                    end
                                    if strcmp(currentoption.doublebins.parameter(4).fit,'none')~=1
                                        ...
                                        eval(['doublefit.parameter(4).parameter = parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.firstbin.fittype '.parameter(4).' currentoption.doublebins.parameter(4).fit '.' currentoption.doublebins.parameter(4).fittype '.parametervalues;']);
                                    end
                                    ...
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.initial.parameters = parameters;']);
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.initial.rmse = rmse;']);
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.initial.fitdata = fitdata;']);
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.unweighted.parameters = unweightedparameters;']);
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.unweighted.rmse = unweightedrmse;']);
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.unweighted.fitdata = unweightedfitdata;']);
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.weighted.parameters = weightedparameters;']);
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.weighted.rmse = weightedrmse;']);
                                    eval(['parameterfits.' branch measure '.' statistic '.doublebin.' firstbin '.' currentoption.doublebins.firstbin.fit '.' currentoption.doublebins.parameter(1).fit '.weighted.fitdata = weightedfitdata;']);
                                    ...
                                    ylabel(secondbinlabel,'FontSize',8,'FontWeight','b');
                                    zlabel([branchlabel ' ' measurelabel ' ' statisticlabel],'FontSize',8,'FontWeight','b');
                                    title(char(' ',[piecetitles{piecetype} ' ' branchlabel ' ' measurelabel ' ' statisticlabel  ' vs ' firstbintitle ' & ' secondbintitle ' -- Initial Fit'],' '),'FontSize',12,'FontWeight','b');
                                    set(gca,'FontSize',6);
                                    ...
                                    filename = sprintf('%s_%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_1st',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    saveas(gcf,filename,'fig');
                                    print('-djpeg',filename);
                                    set(gca,'ZScale','log');
                                    filename = sprintf('%s_%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_1st_lz',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    print('-djpeg',filename);
                                    set(gca,'XScale','log');
                                    filename = sprintf('%s_%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_1st_lz_lx',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    print('-djpeg',filename);
                                    ...
                                    ylabel(secondbinlabel,'FontSize',8,'FontWeight','b');
                                    zlabel([branchlabel ' ' measurelabel ' ' statisticlabel],'FontSize',8,'FontWeight','b');
                                    title(char(' ',[piecetitles{piecetype} ' ' branchlabel ' ' measurelabel ' ' statisticlabel  ' vs ' firstbintitle ' & ' secondbintitle ' -- Unweighted Fit'],' '),'FontSize',12,'FontWeight','b');
                                    set(gca,'FontSize',6);
                                    legendhandle1 = legendhandle1(1);
                                    legendhandles = [legendhandle1 legendhandle2];
                                    legendtext1 = char(' ',sprintf('%s Data',analysis.inputfilename),' ');
                                    ...
                                    legendtext(2) = {legendtextprep};
                                    legend(legendhandles,legendtext,'Location','NorthEast');
                                    filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_%s_uw',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    saveas(gcf,filename,'fig');
                                    print('-djpeg',filename);
                                    set(gca,'ZScale','log');
                                    filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_%s_uw_lz',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    print('-djpeg',filename);
                                    set(gca,'XScale','log');
                                    filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_%s_uw_lz_lx',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    print('-djpeg',filename);
                                    ...
                                    ylabel(secondbinlabel,'FontSize',8,'FontWeight','b');
                                    zlabel([branchlabel ' ' measurelabel ' ' statisticlabel],'FontSize',8,'FontWeight','b');
                                    title(char(' ',[piecetitles{piecetype} ' ' branchlabel ' ' measurelabel ' ' statisticlabel  ' vs ' firstbintitle ' & ' secondbintitle ' -- Weighted Fit'],' '),'FontSize',12,'FontWeight','b');
                                    set(gca,'FontSize',6);
                                    legendhandle1 = legendhandle1(1);
                                    legendhandles = [legendhandle1 legendhandle2];
                                    legendtext1 = char(' ',sprintf('%s Data',analysis.inputfilename),' ');
                                    ...
                                    legendtext(2) = {legendtextprep};
                                    legend(legendhandles,legendtext,'Location','NorthEast');
                                    filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_%s_w',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    saveas(gcf,filename,'fig');
                                    print('-djpeg',filename);
                                    set(gca,'ZScale','log');
                                    filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_%s_w_lz',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    print('-djpeg',filename);
                                    set(gca,'XScale','log');
                                    filename = sprintf('%s_%s_%s_%s_%s_vs_%s_%s_%s_%s_%s_%s_%s_%s_w_lz_lx',analysis.inputfilename,piecetitles{piecetype},branchfilename,measure,statistic,firstbin,secondbin,filename1,filename2,filename3,filename4,filename5,filename6);
                                    print('-djpeg',filename);
                                    if strcmp(mnfitteroption.figuresopen,'n'); close all; end;
                                end
                            end
