...
% Mean
dist(1).type = 'linear';
dist(1).parameter(1) = 5.444e-4; %4.297e-4;
dist(1).parameter(2) = -9.803e-4; %-5.054e-4;
dist(1).parameter(3) = NaN;
dist(1).parameter(4) = NaN;

% Standard Deviation
dist(2).type = 'linear';
dist(2).parameter(1) = 9.191e-4; %4.999e-4;
dist(2).parameter(2) = 2.986e-4; %1.571e-3;
...
dist(3).parameter(2) = 2.1152; %-1.226e0;
...
dist(4).parameter(2) = 44.15; %1.622e1;
