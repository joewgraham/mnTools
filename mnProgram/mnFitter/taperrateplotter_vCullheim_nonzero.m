...
% Mean
dist(1).type = 'power';
dist(1).parameter(1) = 1.993e-4; %5.444e-4; %4.297e-4;
dist(1).parameter(2) = 1.828e0; %-5.054e-4;
dist(1).parameter(3) = 1.268e-3;
dist(1).parameter(4) = NaN;

% Standard Deviation
dist(2).type = 'power';
dist(2).parameter(1) = 1.993e-3; %9.191e-4; %4.999e-4;
dist(2).parameter(2) = 8.457e-1; %1.571e-3;
dist(2).parameter(3) = 0;
dist(2).parameter(4) = NaN;

% Skewness
dist(3).type = 'linear';
dist(3).parameter(1) = 0; %4.032e-1;
dist(3).parameter(2) = 0; %-1.226e0;
dist(3).parameter(3) = NaN;
dist(3).parameter(4) = NaN;

% Kurtosis
dist(4).type = 'linear';
dist(4).parameter(1) = 0; %-8.469e-1;
dist(4).parameter(2) = 3; %1.622e1;
