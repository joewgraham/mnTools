function [parameter,rmse]=exponentialfitterunweighted(x,y,weights)
...
parameter = fminsearch(@(parameter) exponentialrmse(x,y,parameter) , parameter , optimset('Display','off'));
