...
for mnnum = 1 : numbermns
    ...
    for i = 2:length(mnpop.mn(mnnum).piece)
        ...
        if mnpop.mn(mnnum).piece(i).parent == 1
			...
			%mnpop.mn(mnnum).piece(i).proximalbranchvolume = 0;
			...
			%mnpop.mn(mnnum).piece(i).distalbranchvolume = mnpop.mn(mnnum).piece(i).volume;
			...
			%mnpop.mn(mnnum).piece(i).proximalbranchvolume = mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(i).parent).distalbranchvolume;
			%mnpop.mn(mnnum).piece(i).distalbranchvolume = mnpop.mn(mnnum).piece(i).proximalbranchvolume + mnpop.mn(mnnum).piece(i).volume;
            ...
            if mnpop.mn(mnnum).piece(i).parent ~= (i-1)
				...
				%mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(i).parent+1).proximalbranchvolume = 0;
				...
				%mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(i).parent+1).distalbranchvolume = mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(i).parent+1).volume;
		...
		%mnpop.mn(mnnum).piece(i).branchvolume          =(mnpop.mn(mnnum).piece(i).proximalbranchvolume + mnpop.mn(mnnum).piece(i).distalbranchvolume)/2;
		...
		% if ~strcmp(mnpop.mn(mnnum).piece(i).proximaltype,'daughter1  ') && ~strcmp(mnpop.mn(mnnum).piece(i).proximaltype,'daughter2  ') && ~strcmp(mnpop.mn(mnnum).piece(i).proximaltype,'primary    ')
			% if mnpop.mn(mnnum).piece(i).proximalbranchlength ~= mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(i).parent).distalbranchlength
				% disp('Prob with BL?');
				% disp(mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(i).parent));
				% disp(mnpop.mn(mnnum).piece(i));
				% keyboard;
			% end
			% if mnnum == 3 && i == 93
				% disp('MN 3 Piece 93');
    ...
    for j = 2:length(mnpop.mn(mnnum).piece)
        if strcmp(mnpop.mn(mnnum).piece(j).proximaltype,'primary    ')==1 || ...
           ...
           strcmp(mnpop.mn(mnnum).piece(j).proximaltype,'daughter2  ')==1
			...
			mnpop.mn(mnnum).piece(j).proximalbranchlength = 0;
			mnpop.mn(mnnum).piece(j).proximalbranchvolume = 0;
			mnpop.mn(mnnum).piece(j).distalbranchlength = mnpop.mn(mnnum).piece(j).length;
			mnpop.mn(mnnum).piece(j).distalbranchvolume = mnpop.mn(mnnum).piece(j).volume;
			
        else
            mnpop.mn(mnnum).piece(j).cable = mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(j).parent).cable;
			mnpop.mn(mnnum).piece(j).proximalbranchlength = mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(j).parent).distalbranchlength;
			mnpop.mn(mnnum).piece(j).proximalbranchvolume = mnpop.mn(mnnum).piece(mnpop.mn(mnnum).piece(j).parent).distalbranchvolume;
			mnpop.mn(mnnum).piece(j).distalbranchlength = mnpop.mn(mnnum).piece(j).proximalbranchlength + mnpop.mn(mnnum).piece(j).length;
			mnpop.mn(mnnum).piece(j).distalbranchvolume = mnpop.mn(mnnum).piece(j).proximalbranchvolume + mnpop.mn(mnnum).piece(j).volume;
        end
