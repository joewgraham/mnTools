        ...
        elseif type(swcline) == 2
            ...
            if xyz(swcline,:) == xyz(parent(swcline),:)
                ...
                if type(parent(swcline)) == 1
                    ...
                    mnpop.mn(actmnnum).axon(axoncount).proximalxposition = xyz(swcline,1);
                    mnpop.mn(actmnnum).axon(axoncount).proximalyposition = xyz(swcline,2);
                    mnpop.mn(actmnnum).axon(axoncount).proximalzposition = xyz(swcline,3);
        ...
        elseif type(swcline) == 3
            ...
            if xyz(swcline,:) == xyz(parent(swcline),:)
                ...
                if type(parent(swcline)) == 1
                    ...
                    mnpop.mn(actmnnum).dendrite(dendritecount).proximalxposition = xyz(swcline,1);
                    mnpop.mn(actmnnum).dendrite(dendritecount).proximalyposition = xyz(swcline,2);
                    mnpop.mn(actmnnum).dendrite(dendritecount).proximalzposition = xyz(swcline,3);
        ...
        elseif type(swcline) == 4
            ...
            if xyz(swcline,:) == xyz(parent(swcline),:)
                ...
                if type(parent(swcline)) == 1
                    ...
                    mnpop.mn(actmnnum).apical(apicalcount).proximalxposition = xyz(swcline,1);
                    mnpop.mn(actmnnum).apical(apicalcount).proximalyposition = xyz(swcline,2);
                    mnpop.mn(actmnnum).apical(apicalcount).proximalzposition = xyz(swcline,3);
