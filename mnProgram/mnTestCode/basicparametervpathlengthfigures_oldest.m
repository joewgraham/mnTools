...
title('Hillman Algorithm','FontSize',titlefontsize,'FontWeight','b');
set(gca,'xticklabel', []);
...
title('Burke Algorithm','FontSize',titlefontsize,'FontWeight','b');
set(gca,'xticklabel', []);
set(gca,'yticklabel', []);
set(gca,'FontSize',axesfontsize); hold off;
...
errorbar(cullheimbifx,cullheimbify,cullheimbifstd/2,'sg','LineWidth',1.5,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',greenmarkersize);
hold on;
errorbar(cullheimtermx,cullheimtermy,cullheimtermstd/2,'dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);
errorbar(hillmanbifx,hillmanbify,hillmanbifstd/2,'sk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','y','MarkerSize',yellowmarkersize);  
errorbar(hillmantermx,hillmantermy,hillmantermstd/2,'dk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','m','MarkerSize',magentamarkersize);   
...
hold on;
errorbar(cullheimtermx,cullheimtermy,cullheimtermstd/2,'dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);
errorbar(burkebifx,burkebify,burkebifstd/2,'sk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','y','MarkerSize',yellowmarkersize);  
errorbar(burketermx,burketermy,burketermstd/2,'dk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','m','MarkerSize',magentamarkersize);  
set(gca,'xticklabel', []);
set(gca,'yticklabel', []);
set(gca,'FontSize',axesfontsize); hold off; 
...
hold on;
errorbar(cullheimtermx,cullheimtermy,cullheimtermstd/2,'dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);
errorbar(grahambifx,grahambify,grahambifstd/2,'sk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','y','MarkerSize',yellowmarkersize);  
errorbar(grahamtermx,grahamtermy,grahamtermstd/2,'dk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','m','MarkerSize',magentamarkersize);  
set(gca,'xticklabel', []);
set(gca,'yticklabel', []);
set(gca,'FontSize',axesfontsize); hold off; 
...
semilogy(cullheimbifx,cullheimbify,'sg','LineWidth',1.5,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',greenmarkersize);
hold on;
semilogy(cullheimtermx,cullheimtermy,'dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);
semilogy(hillmanbifx,hillmanbify,'sk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','y','MarkerSize',yellowmarkersize);  
semilogy(hillmantermx,hillmantermy,'dk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','m','MarkerSize',magentamarkersize);   
set(gca,'xticklabel', []);
set(gca,'FontSize',axesfontsize); hold off;
...
hold on;
semilogy(cullheimtermx,cullheimtermy,'dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);
semilogy(burkebifx,burkebify,'sk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','y','MarkerSize',yellowmarkersize);  
semilogy(burketermx,burketermy,'dk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','m','MarkerSize',magentamarkersize);   
set(gca,'xticklabel', []);
set(gca,'yticklabel', []);
set(gca,'FontSize',axesfontsize); hold off;
...
hold on;
semilogy(cullheimtermx,cullheimtermy,'dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);
semilogy(grahambifx,grahambify,'sk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','y','MarkerSize',yellowmarkersize);  
semilogy(grahamtermx,grahamtermy,'dk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','m','MarkerSize',magentamarkersize);   
set(gca,'xticklabel', []);
set(gca,'yticklabel', []);
set(gca,'FontSize',axesfontsize); hold off;
