function bifdiameterfigures(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    [ax,h3]=suplabel('Branching Parameters versus Local Diameter'  ,'t');
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'202_Branching_v_Diam');
...
if nargin == 2
    ...
    filename = sprintf('%s_%s_%s',controlanalysis.inputfilename,testanalysis.inputfilename,'202_Branching_v_Diam');
    print('-djpeg',filename);
    %saveas(gcf,filename,'fig');
