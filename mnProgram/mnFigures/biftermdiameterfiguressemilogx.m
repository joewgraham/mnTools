function biftermdiameterfiguressemilogx(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    %semilogx(controldatax1,controldatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    semilogx(controldatax1,controldatay1,'-ob','LineWidth',1.5,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
    hold on;   
    ...
    semilogx(controldatax2,controldatay2,'-sg','LineWidth',1.5,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',indgreenmarkersize);  
    ...
    semilogx(controldatax3,controldatay3,'-dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',indredmarkersize);   
    ...
    [ax,h3]=suplabel('Morphometrics versus Local Diameter (Semi-Log-X)'  ,'t');
    %set(h1,'FontSize',15);
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'104_Morph_v_Diam_SemiLog_x');
...
if nargin == 2
    ...
    controldatastd1 = [controlanalysis.diameter.numbersegments.std];
    %semilogx(controldatax1,controldatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    %semilogx(controldatax1,controldatay1,'-ob','LineWidth',1.5,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
       
    controldatax2   = [controlanalysis.bifurcation.diameter.diameter];
    controldatay2   = [controlanalysis.bifurcation.diameter.numbersegments.mean];
    controldatastd2 = [controlanalysis.bifurcation.diameter.numbersegments.std];
    semilogx(controldatax2,controldatay2,'-sg','LineWidth',1.5,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',greenmarkersize);  
    hold on;
    controldatax3   = [controlanalysis.termination.diameter.diameter];
    controldatay3   = [controlanalysis.termination.diameter.numbersegments.mean];
    controldatastd3 = [controlanalysis.termination.diameter.numbersegments.std];
    semilogx(controldatax3,controldatay3,'-dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);   
    ...
    %semilogx(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    ...
    %semilogx(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    %semilogx(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','
    ...
    %[ax,h1]=suplabel('Diameter (\mum)');
    [ax,h3]=suplabel('Morphometrics versus Diameter (Semi-Log-X)'  ,'t');
    %set(h1,'FontSize',15);
    set(h3,'FontSize',titlefontsize);
    ...
    filename = sprintf('%s_%s_%s',controlanalysis.inputfilename,testanalysis.inputfilename,'104_Morph_v_Diam_SemiLog_x');
    print('-djpeg',filename);
    %saveas(gcf,filename,'fig');
