function vsdiameter2figures(controlanalysis,testanalysis)
% Diameter Figures
...
if nargin == 1
    ...
    [ax,h3]=suplabel('Basic Parameters versus Local Diameter'  ,'t');
    set(h1,'FontSize',15);
    set(h3,'FontSize',20);
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'Diameter_Figure_2');
