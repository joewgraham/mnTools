function vsdiameter2figuressemilog(controlanalysis,testanalysis)
% Diameter Figures
...
if nargin == 1
    ...
    semilogx(controldatax,controldatay,'-ob','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','b','MarkerSize',6);
    ...
    [ax,h3]=suplabel('Basic Parameters versus Local Diameter (Semi-Log)'  ,'t');
    set(h1,'FontSize',15);
    set(h3,'FontSize',20);
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'Diameter_Figure_2_Semi_Log');
