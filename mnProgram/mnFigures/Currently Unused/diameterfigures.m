function diameterfigures(controlanalysis,testanalysis)
% Diameter Figures
...
if nargin == 1
    ...
    errorbar(controldatax,controldatay,0,'-ob','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','b','MarkerSize',6);
    h=gca; set(gca,'XDir','reverse');
    ...
    controldatay   = [controlanalysis.branchorder.cylindricaldiameter.mean];
    controldatastd = [controlanalysis.branchorder.cylindricaldiameter.std];
    ...
    [ax,h3]=suplabel('Diameter versus Local Properties'  ,'t');
    set(h2,'FontSize',15);
    set(h3,'FontSize',20);
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'Diameter_Figure');
