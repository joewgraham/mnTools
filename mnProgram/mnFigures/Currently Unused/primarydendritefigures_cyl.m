function primarydendritefigures_cyl(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    xlabel('Primary Dendrite Cylindrical Diameter (\mum)','FontSize',labelfontsize,'FontWeight','b');
    controldatax = controlanalysis.primarydendrite.cylindricaldiameter.values;
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'Primary_Dendrite_Figure_Cylindrical');
...
if nargin == 2
    ...
    scatter(controldatax,controldatay,'b.');
    testdatax    = testanalysis.primarydendrite.cylindricaldiameter.values;
    testdatay    = testanalysis.primarydendrite.length.values;
    scatter(testdatax,testdatay,'r.');
    [controla,controlb,controlfitx,controlfity,controlr2] = powerfit(controldatax,controldatay,xlim);
    [testa,testb,testfitx,testfity,testr2]                = powerfit(testdatax,testdatay,xlim);
    plot(controlfitx,controlfity,'b');
    ...
    scatter(controldatax,controldatay,'b.');
    testdatax    = testanalysis.primarydendrite.cylindricaldiameter.values;
    testdatay    = testanalysis.primarydendrite.surfacearea.values;
    scatter(testdatax,testdatay,'r.');
    [controla,controlb,controlfitx,controlfity,controlr2] = powerfit(controldatax,controldatay,xlim);
    [testa,testb,testfitx,testfity,testr2]                = powerfit(testdatax,testdatay,xlim);
    plot(controlfitx,controlfity,'b');
    ...
    scatter(controldatax,controldatay,'b.');
    testdatax    = testanalysis.primarydendrite.cylindricaldiameter.values;
    testdatay    = testanalysis.primarydendrite.volume.values;
    scatter(testdatax,testdatay,'r.');
    [controla,controlb,controlfitx,controlfity,controlr2] = powerfit(controldatax,controldatay,xlim);
    [testa,testb,testfitx,testfity,testr2]                = powerfit(testdatax,testdatay,xlim);
    plot(controlfitx,controlfity,'b');
