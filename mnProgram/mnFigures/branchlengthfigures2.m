function branchlengthfigures2(controlanalysis,testanalysis,extent)
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        for scale = 1:numscale
            ...
            if nargin == 1
                ...
                controldatay1   = [controltype.branchlength.rallratio1.mean];
                controldatastd1 = [controltype.branchlength.rallratio1.std];
                if scale == 1
                ...
                controldatay1   = [controltype.branchlength.rallratio1.mean];
                controldatastd1 = [controltype.branchlength.rallratio1.std];
                testdatax1   = [testtype.branchlength.branchlength];
                testdatay1   = [testtype.branchlength.rallratio1.mean];
                testdatastd1 = [testtype.branchlength.rallratio1.std];
                if scale == 1
            ...
            if nargin == 1
                controldatax1   = [controltype.branchlength.branchlength];
                controldatay1   = [controltype.branchlength.rallratio.mean];
                controldatastd1 = [controltype.branchlength.rallratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.branchlength.rallratio.std];
                testdatax1   = [testtype.branchlength.branchlength];
                testdatay1   = [testtype.branchlength.rallratio.mean];
                testdatastd1 = [testtype.branchlength.rallratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.branchlength.branchlength];
                controldatay1   = [controltype.branchlength.rallratio2.mean];
                controldatastd1 = [controltype.branchlength.rallratio2.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.branchlength.rallratio2.std];
                testdatax1   = [testtype.branchlength.branchlength];
                testdatay1   = [testtype.branchlength.rallratio2.mean];
                testdatastd1 = [testtype.branchlength.rallratio2.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.branchlength.branchlength];
                controldatay1   = [controltype.branchlength.parentdaughterratio.mean];
                controldatastd1 = [controltype.branchlength.parentdaughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.branchlength.parentdaughterratio.std];
                testdatax1   = [testtype.branchlength.branchlength];
                testdatay1   = [testtype.branchlength.parentdaughterratio.mean];
                testdatastd1 = [testtype.branchlength.parentdaughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.branchlength.branchlength];
                controldatay1   = [controltype.branchlength.parentdaughter2ratio.mean];
                controldatastd1 = [controltype.branchlength.parentdaughter2ratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.branchlength.parentdaughter2ratio.std];
                testdatax1   = [testtype.branchlength.branchlength];
                testdatay1   = [testtype.branchlength.parentdaughter2ratio.mean];
                testdatastd1 = [testtype.branchlength.parentdaughter2ratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.branchlength.branchlength];
                controldatay1   = [controltype.branchlength.daughterratio.mean];
                controldatastd1 = [controltype.branchlength.daughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.branchlength.daughterratio.std];
                testdatax1   = [testtype.branchlength.branchlength];
                testdatay1   = [testtype.branchlength.daughterratio.mean];
                testdatastd1 = [testtype.branchlength.daughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                [ignore,h]=suplabel([controlanalysis.inputfilename ' -- ' currentpiecetitle ' Branching vs Branch Length' scales{scale}]  ,'t');
                ...
                cd('figures');
                filename = sprintf('%s_%s_15_%.0f_BL2',controlanalysis.inputfilename,currentpiecetype,scale);
            else
                [ignore,h]=suplabel([controlanalysis.inputfilename ' vs ' testanalysis.inputfilename ' -- ' currentpiecetitle ' Branching vs Branch Length' scales{scale}]  ,'t');
                set(h,'FontSize',titlefontsize);
                ...
                cd(piecetypes{piecetype});
                filename = sprintf('%s_%s_%s_15_%.0f_BL2',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype,scale);
            end
