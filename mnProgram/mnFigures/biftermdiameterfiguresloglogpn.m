function biftermdiameterfiguresloglogpn(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    %loglogpn(controldatax1,controldatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    loglogpn(controldatax1,controldatay1,'-ob',':ob','LineWidth',1.5,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
    hold on;   
    ...
    loglogpn(controldatax2,controldatay2,'-sg',':sg','LineWidth',1.5,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',indgreenmarkersize);  
    ...
    loglogpn(controldatax3,controldatay3,'-dr',':dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',indredmarkersize);   
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'105_Morph_v_Diam_loglogpn');
...
if nargin == 2
    ...
    controldatastd1 = [controlanalysis.diameter.numbersegments.std];
    %loglogpn(controldatax1,controldatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    %loglogpn(controldatax1,controldatay1,'-ob',':ob','LineWidth',1.5,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
       
    controldatax2   = [controlanalysis.bifurcation.diameter.diameter];
    controldatay2   = [controlanalysis.bifurcation.diameter.numbersegments.mean];
    controldatastd2 = [controlanalysis.bifurcation.diameter.numbersegments.std];
    loglogpn(controldatax2,controldatay2,'-sg',':sg','LineWidth',1.5,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',greenmarkersize);  
    hold on;
    controldatax3   = [controlanalysis.termination.diameter.diameter];
    controldatay3   = [controlanalysis.termination.diameter.numbersegments.mean];
    controldatastd3 = [controlanalysis.termination.diameter.numbersegments.std];
    loglogpn(controldatax3,controldatay3,'-dr',':dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);   
    ...
    %loglogpn(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    %loglogpn(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);  
    ...
    loglogpn(testdatax2,testdatay2,'-sk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','y','MarkerSize',yellowmarkersize);  
    ...
    loglogpn(testdatax3,testdatay3,'-dk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','m','MarkerSize',magentamarkersize);   
    ...
    %loglogpn(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    %loglogpn(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k'
    ...
    filename = sprintf('%s_%s_%s',controlanalysis.inputfilename,testanalysis.inputfilename,'105_Morph_v_Diam_loglogpn');
    print('-djpeg',filename);
    %saveas(gcf,filename,'fig');
