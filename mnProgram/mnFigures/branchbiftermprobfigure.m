...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype})
        ...
        for versus = 1:4
            ...
            if nargin == 2
                eval(['x2 = [controltype.' currentversus '.' currentversus ']'';']);
                eval(['b2 = [controltype.' currentversus '.numberbifurcatingbranches.mean]'';']);
                eval(['t2 = [controltype.' currentversus '.numberterminatingbranches.mean]'';']);
                n2 = b2 + t2;
