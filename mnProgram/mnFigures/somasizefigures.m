function somasizefigures(controlanalysis,testanalysis)
...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        if nargin == 1
            ...
            plot(controldatax,controldatay,'bo','MarkerFaceColor','b','MarkerEdgeColor','b','MarkerSize',indbluemarkersize);
            ...
            plot(testdatax,testdatay,'ro','MarkerFaceColor','r','MarkerEdgeColor','b','MarkerSize',indbluemarkersize);
            [controlm,controlb,controlfitx,controlfity,controlr2] = linearfit(controldatax,controldatay,xlim);
        ...
        if nargin == 1
            ...
            [ignore xvalues] = hist([controlanalysis.somadiameter.values testanalysis.somadiameter.values]);
        ...
        if nargin == 1
            ...
            cd('figures');
            filename = sprintf('%s_%s_06_vs_Soma',controlanalysis.inputfilename,currentpiecetype);
        else
            ...
            cd(piecetypes{piecetype});
            filename = sprintf('%s_%s_%s_06_vs_Soma',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype);
        end
