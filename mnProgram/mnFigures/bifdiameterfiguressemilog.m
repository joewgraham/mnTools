function bifdiameterfiguressemilog(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    [ax,h3]=suplabel('Branching Parameters versus Local Diameter (Semi-Log)'  ,'t');
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'203_Branching_v_Diam_SemiLog');
...
if nargin == 2
    ...
    filename = sprintf('%s_%s_%s',controlanalysis.inputfilename,testanalysis.inputfilename,'203_Branching_v_Diam_SemiLog');
    print('-djpeg',filename);
    %saveas(gcf,filename,'fig');
