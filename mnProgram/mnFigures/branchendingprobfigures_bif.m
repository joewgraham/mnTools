function branchendingprobfigures_bif(controlanalysis,testanalysis)
...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        if nargin == 1
            ...
            legend(legendhandle,[controlanalysis.inputfilename ' #Bifs'],[controlanalysis.inputfilename ' Bif Length']);
            ...
            cd('figures');
            filename = sprintf('%s_%s_05_1_End_Prob_Length_Bif',controlanalysis.inputfilename,currentpiecetype);
        else
            ...
            set(h,'FontSize',titlefontsize);
            legend(legendhandle,[controlanalysis.inputfilename ' #Bifs'],[controlanalysis.inputfilename ' Bif Length'],[testanalysis.inputfilename ' #Bifs'],[testanalysis.inputfilename ' Bif Length']);
            ...
            cd(piecetypes{piecetype});
            filename = sprintf('%s_%s_%s_05_1_End_Prob_Length_Bif',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype);
        end
...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        if nargin == 1
            ...
            set(h,'FontSize',titlefontsize);
            legend(legendhandle,[controlanalysis.inputfilename ' #Bifs'],[controlanalysis.inputfilename ' Bif SA']);
            cd(controlanalysis.datapathname);
            if exist(piecetypes{piecetype},'dir') ~= 7
                mkdir(piecetypes{piecetype});
            end
            ...
            cd('figures');
            filename = sprintf('%s_%s_05_2_End_Prob_SA_Bif',controlanalysis.inputfilename,currentpiecetype);
        else
            ...
            set(h,'FontSize',titlefontsize);
            legend(legendhandle,[controlanalysis.inputfilename ' #Bifs'],[controlanalysis.inputfilename ' Bif SA'],[testanalysis.inputfilename ' #Bifs'],[testanalysis.inputfilename ' Bif SA']);
            cd(testanalysis.datapathname);
            cd ..
            if exist(sprintf('%s_%s_comparison',controlanalysis.inputfilename,testanalysis.inputfilename),'dir') ~= 7;
                mkdir(sprintf('%s_%s_comparison',controlanalysis.inputfilename,testanalysis.inputfilename));
            ...
            cd(piecetypes{piecetype});
            filename = sprintf('%s_%s_%s_05_2_End_Prob_SA_Bif',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype);
        end
...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        if nargin == 1
            ...
            set(h,'FontSize',titlefontsize);
            legend(legendhandle,[controlanalysis.inputfilename ' #Bifs'],[controlanalysis.inputfilename ' Bif Volume']);
            cd(controlanalysis.datapathname);
            if exist(piecetypes{piecetype},'dir') ~= 7
                mkdir(piecetypes{piecetype});
            end
            ...
            cd('figures');
            filename = sprintf('%s_%s_05_3_End_Prob_Volume_Bif',controlanalysis.inputfilename,currentpiecetype);
        else
            ...
            set(h,'FontSize',titlefontsize);
            legend(legendhandle,[controlanalysis.inputfilename ' #Bifs'],[controlanalysis.inputfilename ' Bif Volume'],[testanalysis.inputfilename ' #Bifs'],[testanalysis.inputfilename ' Bif Volume']);
            cd(testanalysis.datapathname);
            cd ..
            if exist(sprintf('%s_%s_comparison',controlanalysis.inputfilename,testanalysis.inputfilename),'dir') ~= 7;
                mkdir(sprintf('%s_%s_comparison',controlanalysis.inputfilename,testanalysis.inputfilename));
            ...
            cd(piecetypes{piecetype});
            filename = sprintf('%s_%s_%s_05_3_End_Prob_Volume_Bif',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype);
        end
