function biftermdiameterfiguressemilogypn(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    %semilogypn(controldatax1,controldatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    semilogypn(controldatax1,controldatay1,'-ob',':ob','LineWidth',1.5,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
    hold on;   
    ...
    semilogypn(controldatax2,controldatay2,'-sg',':sg','LineWidth',1.5,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',indgreenmarkersize);  
    ...
    semilogypn(controldatax3,controldatay3,'-dr',':dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',indredmarkersize);   
    ...
    [ax,h3]=suplabel('Morphometrics versus Local Diameter (Semi-Log-Y)'  ,'t');
    %set(h1,'FontSize',15);
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'104_Morph_v_Diam_SemiLog_ypn');
...
if nargin == 2
    ...
    controldatastd1 = [controlanalysis.diameter.numbersegments.std];
    %semilogypn(controldatax1,controldatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    %semilogypn(controldatax1,controldatay1,'-ob',':ob','LineWidth',1.5,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
       
    controldatax2   = [controlanalysis.bifurcation.diameter.diameter];
    controldatay2   = [controlanalysis.bifurcation.diameter.numbersegments.mean];
    controldatastd2 = [controlanalysis.bifurcation.diameter.numbersegments.std];
    semilogypn(controldatax2,controldatay2,'-sg',':sg','LineWidth',1.5,'MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',greenmarkersize);  
    hold on;
    controldatax3   = [controlanalysis.termination.diameter.diameter];
    controldatay3   = [controlanalysis.termination.diameter.numbersegments.mean];
    controldatastd3 = [controlanalysis.termination.diameter.numbersegments.std];
    semilogypn(controldatax3,controldatay3,'-dr',':dr','LineWidth',1.5,'MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',redmarkersize);   
    ...
    %semilogypn(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    %semilogypn(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);  
    ...
    semilogypn(testdatax2,testdatay2,'-sk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','y','MarkerSize',yellowmarkersize);  
    ...
    semilogypn(testdatax3,testdatay3,'-dk','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','m','MarkerSize',magentamarkersize);   
    ...
    %semilogypn(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','w','MarkerSize',10);
    %semilogypn(testdatax1,testdatay1,'-ok','LineWidth',1,'MarkerEdgeColor','
    %k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
    testdatax2   = [testanalysis.bifurcation.diameter.diameter];
    ...
    %[ax,h1]=suplabel('Diameter (\mum)');
    [ax,h3]=suplabel('Morphometrics versus Diameter (Semi-Log-Y)'  ,'t');
    %set(h1,'FontSize',15);
    set(h3,'FontSize',titlefontsize);
    ...
    filename = sprintf('%s_%s_%s',controlanalysis.inputfilename,testanalysis.inputfilename,'104_Morph_v_Diam_SemiLog_ypn');
    print('-djpeg',filename);
    %saveas(gcf,filename,'fig');
