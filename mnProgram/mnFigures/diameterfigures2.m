function diameterfigures2(controlanalysis,testanalysis,extent)
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        for scale = 1:numscale
            ...
            if nargin == 1
                ...
                controldatay1   = [controltype.diameter.rallratio1.mean];
                controldatastd1 = [controltype.diameter.rallratio1.std];
                if scale == 1
                ...
                controldatay1   = [controltype.diameter.rallratio1.mean];
                controldatastd1 = [controltype.diameter.rallratio1.std];
                testdatax1   = [testtype.diameter.diameter];
                testdatay1   = [testtype.diameter.rallratio1.mean];
                testdatastd1 = [testtype.diameter.rallratio1.std];
                if scale == 1
            ...
            if nargin == 1
                controldatax1   = [controltype.diameter.diameter];
                controldatay1   = [controltype.diameter.rallratio.mean];
                controldatastd1 = [controltype.diameter.rallratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.diameter.rallratio.std];
                testdatax1   = [testtype.diameter.diameter];
                testdatay1   = [testtype.diameter.rallratio.mean];
                testdatastd1 = [testtype.diameter.rallratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.diameter.diameter];
                controldatay1   = [controltype.diameter.rallratio2.mean];
                controldatastd1 = [controltype.diameter.rallratio2.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.diameter.rallratio2.std];
                testdatax1   = [testtype.diameter.diameter];
                testdatay1   = [testtype.diameter.rallratio2.mean];
                testdatastd1 = [testtype.diameter.rallratio2.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.diameter.diameter];
                controldatay1   = [controltype.diameter.parentdaughterratio.mean];
                controldatastd1 = [controltype.diameter.parentdaughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.diameter.parentdaughterratio.std];
                testdatax1   = [testtype.diameter.diameter];
                testdatay1   = [testtype.diameter.parentdaughterratio.mean];
                testdatastd1 = [testtype.diameter.parentdaughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.diameter.diameter];
                controldatay1   = [controltype.diameter.parentdaughter2ratio.mean];
                controldatastd1 = [controltype.diameter.parentdaughter2ratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.diameter.parentdaughter2ratio.std];
                testdatax1   = [testtype.diameter.diameter];
                testdatay1   = [testtype.diameter.parentdaughter2ratio.mean];
                testdatastd1 = [testtype.diameter.parentdaughter2ratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.diameter.diameter];
                controldatay1   = [controltype.diameter.daughterratio.mean];
                controldatastd1 = [controltype.diameter.daughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.diameter.daughterratio.std];
                testdatax1   = [testtype.diameter.diameter];
                testdatay1   = [testtype.diameter.daughterratio.mean];
                testdatastd1 = [testtype.diameter.daughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                [ignore,h]=suplabel([controlanalysis.inputfilename ' -- ' currentpiecetitle ' Branching Parameters vs Local Diameter' scales{scale}]  ,'t');
                ...
                cd('figures');
                filename = sprintf('%s_%s_09_%.0f_Diam2',controlanalysis.inputfilename,currentpiecetype,scale);
            else
                [ignore,h]=suplabel([controlanalysis.inputfilename ' vs ' testanalysis.inputfilename ' -- ' currentpiecetitle ' Branching Parameters vs Local Diameter' scales{scale}]  ,'t');
                set(h,'FontSize',titlefontsize);
                ...
                cd(piecetypes{piecetype});
                filename = sprintf('%s_%s_%s_09_%.0f_Diam2',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype,scale);
            end
