function somavolumefigures(controlanalysis,testanalysis)
...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        if nargin == 1
            hist(controlanalysis.soma.volume.values);
            xlim(xlimits);
            set(gca,'xticklabel', []);
            h = findobj(gca,'Type','patch');
            set(h,'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
        else
            [ignore xvalues] = hist([controlanalysis.soma.volume.values testanalysis.soma.volume.values]);
            hist(controlanalysis.soma.volume.values,xvalues);
            hist(testanalysis.soma.volume.values,xvalues);
            xlim(xlimits);
            set(gca,'xticklabel', []);
            h = findobj(gca,'Type','patch');
        ...
        xlabel('Soma Volume (\mum^3)','FontSize',labelfontsize,'FontWeight','b');
        if nargin == 1
            controldatax = controlanalysis.soma.volume.values;
        ...
        if nargin == 1
            [ignore,h]=suplabel([controlanalysis.inputfilename ' -- ' currentpiecetitle ' Morphometrics vs Soma Volume']  ,'t');
            ...
            cd('figures');
            filename = sprintf('%s_%s_06_3_vs_SomaVol',controlanalysis.inputfilename,currentpiecetype);
        else
            [ignore,h]=suplabel([controlanalysis.inputfilename ' & ' testanalysis.inputfilename ' -- ' currentpiecetitle ' Morphometrics vs Soma Volume']  ,'t');
            set(h,'FontSize',titlefontsize);
            ...
            cd(piecetypes{piecetype});
            filename = sprintf('%s_%s_%s_06_3_vs_SomaVol',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype);
        end
