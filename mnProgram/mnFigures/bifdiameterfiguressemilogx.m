function bifdiameterfiguressemilogx(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    semilogx(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);   
    hold on;   
    ...
    [ax,h3]=suplabel('Branching Parameters versus Local Diameter (Semi-Log-X)'  ,'t');
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'203_Branching_v_Diam_SemiLog_x');
...
if nargin == 2
    ...
    filename = sprintf('%s_%s_%s',controlanalysis.inputfilename,testanalysis.inputfilename,'203_Branching_v_Diam_SemiLog_x');
    print('-djpeg',filename);
    %saveas(gcf,filename,'fig');
