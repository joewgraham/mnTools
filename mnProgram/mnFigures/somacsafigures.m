function somacsafigures(controlanalysis,testanalysis)
...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        if nargin == 1
            hist(controlanalysis.soma.csa.values);
            xlim(xlimits);
            set(gca,'xticklabel', []);
            h = findobj(gca,'Type','patch');
            set(h,'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
        else
            [ignore xvalues] = hist([controlanalysis.soma.csa.values testanalysis.soma.csa.values]);
            hist(controlanalysis.soma.csa.values,xvalues);
            hist(testanalysis.soma.csa.values,xvalues);
            xlim(xlimits);
            set(gca,'xticklabel', []);
            h = findobj(gca,'Type','patch');
        ...
        xlabel('Soma CSA (\mum^2)','FontSize',labelfontsize,'FontWeight','b');
        if nargin == 1
            controldatax = controlanalysis.soma.csa.values;
        ...
        if nargin == 1
            [ignore,h]=suplabel([controlanalysis.inputfilename ' -- ' currentpiecetitle ' Morphometrics vs Soma CSA']  ,'t');
            ...
            cd('figures');
            filename = sprintf('%s_%s_06_2_vs_SomaCSA',controlanalysis.inputfilename,currentpiecetype);
        else
            [ignore,h]=suplabel([controlanalysis.inputfilename ' & ' testanalysis.inputfilename ' -- ' currentpiecetitle ' Morphometrics vs Soma CSA']  ,'t');
            set(h,'FontSize',titlefontsize);
            ...
            cd(piecetypes{piecetype});
            filename = sprintf('%s_%s_%s_06_2_vs_SomaCSA',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype);
        end
