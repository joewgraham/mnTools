function trunkpositionfigures(controlanalysis,testanalysis)
...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        box on;
        hold on;
        ylabel('x Distance from Centroid','FontSize',labelfontsize,'FontWeight','b');
        xlabel('y Distance from Centroid','FontSize',labelfontsize,'FontWeight','b');
        if nargin == 1
            controldatax = controltype.trunk.yfromcentroid.values;
            controldatay = controltype.trunk.xfromcentroid.values;
            ...
            testdatay = testtype.trunk.xfromcentroid.values;
        ...
        box on;
        hold on;
        ylabel('y Distance from Centroid','FontSize',labelfontsize,'FontWeight','b');
        xlabel('x Distance from Centroid','FontSize',labelfontsize,'FontWeight','b');
        if nargin == 1
            controldatax = controltype.trunk.xfromcentroid.values;
            controldatay = controltype.trunk.yfromcentroid.values;
            scatter(controldatax,controldatay,'bo');            
        else
            controldatax = controltype.trunk.xfromcentroid.values;
            controldatay = controltype.trunk.yfromcentroid.values;
            ...
            testdatay = testtype.trunk.yfromcentroid.values;
            scatter(testdatax,testdatay,'rx');
        end
        set(gca,'FontSize',axesfontsize);
        hold off;
        ...
        box on;
        hold on;
        ylabel('z Distance from Centroid','FontSize',labelfontsize,'FontWeight','b');
        xlabel('x Distance from Centroid','FontSize',labelfontsize,'FontWeight','b');
        if nargin == 1
            controldatax = controltype.trunk.xfromcentroid.values;
            controldatay = controltype.trunk.zfromcentroid.values;
            scatter(controldatax,controldatay,'bo');            
        else
            controldatax = controltype.trunk.xfromcentroid.values;
            controldatay = controltype.trunk.zfromcentroid.values;
            scatter(controldatax,controldatay,'bo');
            testdatax = testtype.trunk.xfromcentroid.values;
            testdatay = testtype.trunk.zfromcentroid.values;
            scatter(testdatax,testdatay,'rx');
        end
        set(gca,'FontSize',axesfontsize);
        hold off;
        ...
        if nargin == 1
            [ignore,h]=suplabel([controlanalysis.inputfilename ' -- ' currentpiecetitle ' Trunk Position']  ,'t');
            ...
            cd('figures');
            filename = sprintf('%s_%s_07_3_TrunkPos',controlanalysis.inputfilename,currentpiecetype);
        else
            [ignore,h]=suplabel([controlanalysis.inputfilename ' vs ' testanalysis.inputfilename ' -- ' currentpiecetitle ' Trunk Position']  ,'t');
            set(h,'FontSize',titlefontsize);
            ...
            cd(piecetypes{piecetype});
            filename = sprintf('%s_%s_%s_07_3_TrunkPos',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype);
        end
