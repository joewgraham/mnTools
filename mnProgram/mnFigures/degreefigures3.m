function degreefigures3(controlanalysis,testanalysis,extent)
% Bif Degree figures
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        for scale = 1:numscale
            ...
            if nargin == 1
                ...
                controldatay1   = [controltype.degree.rallratio1.mean];
                controldatastd1 = [controltype.degree.rallratio1.std];
                if scale == 1
                ...
                controldatay1   = [controltype.degree.rallratio1.mean];
                controldatastd1 = [controltype.degree.rallratio1.std];
                testdatax1   = [testtype.degree.degree];
                testdatay1   = [testtype.degree.rallratio1.mean];
                testdatastd1 = [testtype.degree.rallratio1.std];
                if scale == 1
            ...
            if nargin == 1
                controldatax1   = [controltype.degree.degree];
                controldatay1   = [controltype.degree.rallratio.mean];
                controldatastd1 = [controltype.degree.rallratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.degree.rallratio.std];
                testdatax1   = [testtype.degree.degree];
                testdatay1   = [testtype.degree.rallratio.mean];
                testdatastd1 = [testtype.degree.rallratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.degree.degree];
                controldatay1   = [controltype.degree.rallratio2.mean];
                controldatastd1 = [controltype.degree.rallratio2.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.degree.rallratio2.std];
                testdatax1   = [testtype.degree.degree];
                testdatay1   = [testtype.degree.rallratio2.mean];
                testdatastd1 = [testtype.degree.rallratio2.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.degree.degree];
                controldatay1   = [controltype.degree.parentdaughterratio.mean];
                controldatastd1 = [controltype.degree.parentdaughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.degree.parentdaughterratio.std];
                testdatax1   = [testtype.degree.degree];
                testdatay1   = [testtype.degree.parentdaughterratio.mean];
                testdatastd1 = [testtype.degree.parentdaughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.degree.degree];
                controldatay1   = [controltype.degree.parentdaughter2ratio.mean];
                controldatastd1 = [controltype.degree.parentdaughter2ratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.degree.parentdaughter2ratio.std];
                testdatax1   = [testtype.degree.degree];
                testdatay1   = [testtype.degree.parentdaughter2ratio.mean];
                testdatastd1 = [testtype.degree.parentdaughter2ratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                controldatax1   = [controltype.degree.degree];
                controldatay1   = [controltype.degree.daughterratio.mean];
                controldatastd1 = [controltype.degree.daughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                else
                    plot(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);
                ...
                controldatastd1 = [controltype.degree.daughterratio.std];
                testdatax1   = [testtype.degree.degree];
                testdatay1   = [testtype.degree.daughterratio.mean];
                testdatastd1 = [testtype.degree.daughterratio.std];
                if scale == 1
                    errorbar(controldatax1,controldatay1,controldatastd1/2,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);
                    errorbar(testdatax1,testdatay1,testdatastd1/2,'-ok','LineWidth',1,'MarkerEdgeColor','k','MarkerFaceColor','c','MarkerSize',cyanmarkersize);
                else
            ...
            if nargin == 1
                [ignore,h]=suplabel([controlanalysis.inputfilename ' -- ' currentpiecetitle ' Branching vs Degree' scales{scale}]  ,'t');
                ...
                cd('figures');
                filename = sprintf('%s_%s_21_%.0f_Deg3',controlanalysis.inputfilename,currentpiecetype,scale);
            else
                [ignore,h]=suplabel([controlanalysis.inputfilename ' vs ' testanalysis.inputfilename ' -- ' currentpiecetitle ' Branching vs Degree' scales{scale}]  ,'t');
                set(h,'FontSize',titlefontsize);
                ...
                cd(piecetypes{piecetype});
                filename = sprintf('%s_%s_%s_21_%.0f_Deg3',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype,scale);
            end
