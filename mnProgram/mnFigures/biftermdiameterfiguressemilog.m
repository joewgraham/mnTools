function biftermdiameterfiguressemilog(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    [ax,h3]=suplabel('Morphometrics versus Local Diameter (Semi-Log)'  ,'t');
    %set(h1,'FontSize',15);
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'104_Morph_v_Diam_SemiLog');
...
if nargin == 2
    ...
    %[ax,h1]=suplabel('Diameter (\mum)');
    [ax,h3]=suplabel('Morphometrics versus Diameter (Semi-Log)'  ,'t');
    %set(h1,'FontSize',15);
    set(h3,'FontSize',titlefontsize);
    ...
    filename = sprintf('%s_%s_%s',controlanalysis.inputfilename,testanalysis.inputfilename,'104_Morph_v_Diam_SemiLog');
    print('-djpeg',filename);
    %saveas(gcf,filename,'fig');
