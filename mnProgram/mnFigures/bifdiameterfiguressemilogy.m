function bifdiameterfiguressemilogy(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    semilogy(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',indbluemarkersize);   
    hold on;   
    ...
    [ax,h3]=suplabel('Branching Parameters versus Local Diameter (Semi-Log-Y)'  ,'t');
    ...
    filename = sprintf('%s_%s',controlanalysis.inputfilename,'203_Branching_v_Diam_SemiLog_y');
...
if nargin == 2
    ...
    controldatay1   = [controlanalysis.diameter.rallratio1.mean];
    controldatastd1 = [controlanalysis.diameter.rallratio1.std];
    semilogy(controldatax1,controldatay1,'-ob','LineWidth',2,'MarkerEdgeColor','b','MarkerFaceColor','b','MarkerSize',bluemarkersize);   
    hold on;   
    ...
    filename = sprintf('%s_%s_%s',controlanalysis.inputfilename,testanalysis.inputfilename,'203_Branching_v_Diam_SemiLog_y');
    print('-djpeg',filename);
    %saveas(gcf,filename,'fig');
