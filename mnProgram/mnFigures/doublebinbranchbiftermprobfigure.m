function doublebinbranchbiftermprobfigure(controlanalysis,testanalysis)
...
if nargin == 1
    ...
    y1 = [controlanalysis.doublebin.array.numberterminations];
    y2 = [controlanalysis.doublebin.array.numberbifurcations];
    n = ([controlanalysis.doublebin.array.numberbifurcations] + [controlanalysis.doublebin.array.numberterminations]);
    ...
    figure;
        ...
        %subplot(2,1,1);
            plot3(x(:,1),x(:,2),(y2 + y1),'LineWidth',2);
            hold on;
            plot3(x(:,1),x(:,2),y2,'sg','MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',indgreenmarkersize);
            plot3(x(:,1),x(:,2),y1,'dr','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',indredmarkersize);
        ...
        figure
            total = y2 + y1;
            plot3(x(:,1),x(:,2),y2./total,'sg','MarkerEdgeColor','g','MarkerFaceColor','g','MarkerSize',indgreenmarkersize);
            hold on;
            plot3(x(:,1),x(:,2),y1./total,'dr','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',indredmarkersize);
            plot3(x(:,1),x(:,2),y2fit./n,'-g','LineWidth',2);
            plot3(x(:,1),x(:,2),y1fit./n,'-r','LineWidth',2);
        ...
        filename = sprintf('%s_%s',controlanalysis.inputfilename,'401_DoubleBin_Branch_Bif_Term_Prob');
    ...
    figure;
        ...
        filename = sprintf('%s_%s',controlanalysis.inputfilename,'401_DoubleBin_Branch_Bif_Term_Prob_SemiLog');
        print('-djpeg',filename);
        %saveas(gcf,filename,'fig');        
