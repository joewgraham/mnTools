function cableanalysisfigures(controlanalysis,testanalysis)
...
for piecetype = 2:4
    ...
    if isfield(controlanalysis,piecetypes{piecetype}) && goahead
        ...
        for branchtype = 1:3
            ...
            box on;
            hold on;
            xlabel('Length (\mum)','FontSize',labelfontsize,'FontWeight','b');
            ylabel('Number of Branches','FontSize',labelfontsize,'FontWeight','b');
            if nargin == 1
                hist(controlcable.length.values,50);
                h = findobj(gca,'Type','patch');
                set(h(1),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
            else
                [totaldata xvalues] = hist([controlcable.length.values testcable.length.values],50);
                hist(controlcable.length.values,xvalues);
                hist(testcable.length.values,xvalues);
                h = findobj(gca,'Type','patch');
            ...
            box on;
            hold on;
            xlabel('Surface Area (\mum^2)','FontSize',labelfontsize,'FontWeight','b');
            ylabel('Number of Branches','FontSize',labelfontsize,'FontWeight','b');
            if nargin == 1
                hist(controlcable.surfacearea.values,50);
                h = findobj(gca,'Type','patch');
                set(h(1),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
            else
                [totaldata xvalues] = hist([controlcable.surfacearea.values testcable.surfacearea.values],50);
                hist(controlcable.surfacearea.values,xvalues);
                hist(testcable.surfacearea.values,xvalues);
                h = findobj(gca,'Type','patch');
                set(h(2),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
                set(h(1),'FaceColor','r','EdgeColor','r','FaceAlpha',0.5,'EdgeAlpha',0.5);
            end
            ...
            ylabel('Number of Branches','FontSize',labelfontsize,'FontWeight','b');
            if nargin == 1
                hist(controlcable.volume.values,50);
                h = findobj(gca,'Type','patch');
                set(h(1),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
            else
                [totaldata xvalues] = hist([controlcable.volume.values testcable.volume.values],50);
                hist(controlcable.volume.values,xvalues);
                hist(testcable.volume.values,xvalues);
                h = findobj(gca,'Type','patch');
                set(h(2),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
                set(h(1),'FaceColor','r','EdgeColor','r','FaceAlpha',0.5,'EdgeAlpha',0.5);
            end
            ...
            ylabel('Number of Branches','FontSize',labelfontsize,'FontWeight','b');
            if nargin == 1
                hist(controlcable.proximaldiameter.values,50);
                h = findobj(gca,'Type','patch');
                set(h(1),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
            else
                [totaldata xvalues] = hist([controlcable.proximaldiameter.values testcable.proximaldiameter.values],50);
                hist(controlcable.proximaldiameter.values,xvalues);
                hist(testcable.proximaldiameter.values,xvalues);
                h = findobj(gca,'Type','patch');
                set(h(2),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
                set(h(1),'FaceColor','r','EdgeColor','r','FaceAlpha',0.5,'EdgeAlpha',0.5);
            end
            ...
            box on;
            hold on;
            xlabel('Distal Diameter (\mum)','FontSize',labelfontsize,'FontWeight','b');
            ylabel('Number of Branches','FontSize',labelfontsize,'FontWeight','b');
            if nargin == 1
                hist(controlcable.distaldiameter.values,50);
                h = findobj(gca,'Type','patch');
                set(h(1),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
            else
                [totaldata xvalues] = hist([controlcable.distaldiameter.values testcable.distaldiameter.values],50);
                hist(controlcable.distaldiameter.values,xvalues);
                hist(testcable.distaldiameter.values,xvalues);
                h = findobj(gca,'Type','patch');
                set(h(2),'FaceColor','b','EdgeColor','b','FaceAlpha',0.5,'EdgeAlpha',0.5);
                set(h(1),'FaceColor','r','EdgeColor','r','FaceAlpha',0.5,'EdgeAlpha',0.5);
            end
            ...
            if nargin == 1
                ...
                cd('figures');
                filename = sprintf('%s_%s_23_%.0f_Cable',controlanalysis.inputfilename,currentpiecetype,branchtype);
            else
                ...
                cd(piecetypes{piecetype});
                filename = sprintf('%s_%s_%s_23_%.0f_Cable',controlanalysis.inputfilename,testanalysis.inputfilename,currentpiecetype,branchtype);
            end
